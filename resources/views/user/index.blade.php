                        ...
                        @foreach($slider_desktop as $key => $slider)
                            @if($slider->photo)
                                <div class="swiper-slide position-relative">
                                    <img src="{{url($slider->photo->path)}}" class="img_slider"  alt="vandidad">
                                </div>
                            @endif
                        @endforeach
                    </div>
                                    ...
                                    <div class="project_item bg-white shadow-sm rounded-sm my-2">
                                        ...
                                        <div class="project_content p-2">
                                            ...
                                            <div class="project_content_footer py-2 d-flex align-items-center justify-content-between">
                                                ...
                                                {{--                                        </div>--}}
                                                {{--                                        <span class="mx-2">estate4istanbul</span>--}}

                                                {{--                                    </div>--}}

                                                {{--                                    <div class="project_content_footer_icon d-flex ">--}}
                                                {{--                                        <div class="project_icon mx-1">--}}
                    ...
                    @foreach($articles as $article)
                        <div class="col-lg-3 col-12">
                            <a href="{{route('user.blog.show',$article->slug)}}">
                                <div class="project_item bg-white shadow-sm rounded-sm my-2">
                                    <div class="project_image position-relative">
                                        <img src="{{$article->photo?url($article->photo):url('assets/user/pic/blog1.jpg')}}" alt="{{$article->title}}" />
                                        <div class="project_image_detail "></div>
                                        <div class="project_image_detail_1 text-white d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                {{--                                        <i class="fa fa-map-marker  px-2"></i>--}}
                        ...
                        @foreach($project_categories as $project_category)
                            <div class="element-box__item d-flex m-2 flex-column align-items-center shadow-sm py-4">
                                <div class="element-box__item__icon py-2">
                                    @if($project_category->type== "icon")
                                        {!! $project_category->icon !!}
                                    @else
                                        <img src="{{url($project_category->image ? $project_category->image : '') }}" width="50px" height="50px" />
                                    @endif
                                </div>
                                <strong>{{$project_category->title}}</strong>
                            </div>
                        @endforeach
                                ...
                                <div class="col-lg-4 col-12">
                                    <div class="row">
                                            @foreach($cities as $key => $city)
                                                ...
                                                <a href="{{route('user.project.show',$city->id)}}">
                                                    <div class="project_item bg-white shadow-sm rounded-sm">
                                                        <div class="project_image position-relative">
                                                            @foreach($city->photos->take(1) as $photo)
            ...
            <div class="container">
                ...
                <div class="project_section__navbar mb-2">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <a href="{{route('user.agent.show',$agent->slug)}}">
                                <div class="project_item bg-white shadow-sm rounded-sm">
                                <div class="project_image position-relative">
                                    <img src="{{$agent->photo ?: ''}}" />
                                    <div class="project_image_detail "></div>
                                ...
                                <div class="project_content p-2">
                                    <div class="project_content_description d-flex flex-column">
                                        <strong class="py-2">{{$agent->name}}</strong>
                                        <p>{!! str_limit($agent->description, 30) !!} </p>
                                    </div>
                                </div>
                            </div>
                            </a>
