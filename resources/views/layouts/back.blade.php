...
<head>
    ...
    <title>Avartin Admin Panel</title>
    <!--favicon-->
    <link rel="icon"
          href="{{url('assets/user/pic/logo.png')}}"
          type="image/x-icon">
    <!-- Vector CSS -->
    <link href="{{url('assets/admin/css/jquery-jvectormap-2.css')}}" rel="stylesheet">
    <!-- simplebar CSS-->
    <link href="{{url('assets/admin/css/simplebar.css')}}" rel="stylesheet">
    <!-- Bootstrap core CSS-->
    <link href="{{url('assets/admin/css/bootstrap.css')}}" rel="stylesheet">
    <!-- animate CSS-->
    <link href="{{url('assets/admin/css/animate.css')}}" rel="stylesheet" type="text/css">
    <!-- Icons CSS-->
    <link href="{{url('assets/admin/css/icons.css')}}" rel="stylesheet" type="text/css">
    <!-- Metismenu CSS-->
    <link href="{{url('assets/admin/css/metisMenu.css?v=').time()}}" rel="stylesheet">
    <link rel="stylesheet" href="{{url('assets/admin/css/jquery-ui.css')}}">
    <!-- Chosen css -->
    <link rel="stylesheet" href="{{ url('assets/admin/chosen/css.css')}}">
    <!-- Custom Style-->
    <link href="{{url('assets/admin/css/app-style.css?v=').time()}}" rel="stylesheet">
    <link href="{{url('assets/admin/css/fonts.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ url('assets/admin/css/jgrowl.min.css') }}"/>
        ...
        <div class="simplebar-scroll-content" style="padding-right: 17px; margin-bottom: -34px;">
            <div class="simplebar-content" style="padding-bottom: 17px; margin-right: -17px;">
                ...
                <div class="brand-logo" style="cursor: pointer">
                    <img onclick="window.open('{{route('user.index')}}','_blank')" src="{{url('assets/user/pic/logo.png')}}" class="logo-icon full" style="width: 100%;height: 100px; object-fit: contain" alt="logo icon">
                    <img onclick="window.open('{{route('user.index')}}','_blank')" src="{{url('assets/user/pic/logo.png')}}" class="logo-icon mini" style="width: 100%;height: auto" alt="logo icon">
                ...
                <ul class="metismenu mm-show" id="menu">
                    ...
                    <li class="" >
                        ...
                        <ul class="mm-collapse" style="height: 2px;">
                            <li><a href="{{ route('slider-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i>
                                    اسلایدر</a></li>
                            {{-- <li><a href="{{ route('menu-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i>
                                    منو</a></li> --}}
                    ...
                    <li class="">
                        ...
                        <ul class="mm-collapse" style="height: 2px;">
                            <li><a href="{{ route('project-category-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i>
                                    دسته بندی پروژه ها</a></li>
                            ...
                            <li><a href="{{ route('agent.index') }}"><i class="zmdi zmdi-dot-circle-alt"></i> لیست نمایندگان</a>
                            </li>
                    ...
                    <li class="">
                        ...
                        <ul class="mm-collapse" style="height: 2px;">
                            <li><a href="{{ route('contract-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i>معاملات انجام شده</a></li>
                            <li><a href="{{ route('contract-list') }}?type=canceled"><i class="zmdi zmdi-dot-circle-alt"></i>معاملات انجام نشده</a></li>
                            <li><a href="{{ route('contract-canceled-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i>گزارش کنسل شده ها</a></li>
                            <li><a href="{{ route('user-refer-report-list') }}?type=canceled"><i class="zmdi zmdi-dot-circle-alt"></i>گزارش ارجاعات</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="">
                        ...
                        <ul class="mm-collapse" style="height: 2px;">
                            <li><a href="{{ route('slider-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i>
                                    اسلایدر</a></li>
                            <li><a href="{{ route('post-category-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i>
                                    لیست دسته بندی نوشته‌ها</a></li>
                            <li><a href="{{ route('post-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i> لیست
                                    نوشته‌ها</a></li>
                            <li><a href="{{ route('comment-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i> لیست
                                    کامنت‌ها</a></li>
                            <li><a href="{{ route('article-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i> لیست
                                    مقالات</a></li>
                            <li><a href="{{ route('passports.index') }}"><i class="zmdi zmdi-dot-circle-alt"></i> درخواست تماس پاسپورت</a></li>
                            <li><a href="{{ route('faq-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i> سوالات متداول</a></li>
                        </ul>
                    </li>
                    <li class="">
                        ...
                        <ul class="mm-collapse" style="height: 2px;">
                            ...
                            <li>
                                <a href="{{ route('villa-search-index') }}">
                            ...
                            <li>
                                <a href="{{ route('villa-list','published') }}">
                                    <i class="zmdi zmdi-dot-circle-alt"></i>
                            ...
                            <li>
                                <a href="{{ route('villa-list','pending') }}">
                                    <i class="zmdi zmdi-dot-circle-alt"></i>
                                    ...
                                    @endphp
                                    @if($villa_pending > 0)
                                        <div class="badge badge-light ml-auto">{{ $villa_pending }}</div>
                                    @endif
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('villa-list','failed') }}">
                                    <i class="zmdi zmdi-dot-circle-alt"></i>
                                    <span class="badge badge-danger">رد شده</span>
                                    لیست ملک‌ها
                                </a>
                            </li>
                            <li><a href="{{ route('city-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i> لیست
                                    مناطق</a></li>
                            <li><a href="{{ route('location-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i> لیست
                                    نواحی</a></li>
                            <li><a href="{{ route('re-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i> لیست درخواست
                                    ها</a></li>
                            <li><a href="{{ route('share-list') }}"><i class="zmdi zmdi-dot-circle-alt"></i> لینک شبگه
                                    اجتماعی</a></li>
                        </ul>
                    </li>
                    <li class="">
                        ...
                        <ul class="mm-collapse" style="height: 2px;">
                            <li><a href="{{ route('newsletter-list-home') }}"><i class="zmdi zmdi-dot-circle-alt"></i>
                                    لیست عضوهای صفحه اصلی</a></li>
                            <li><a href="{{ route('newsletter-list-location') }}"><i
                                            class="zmdi zmdi-dot-circle-alt"></i> لیست عضوهای هر محله</a></li>
                            <li><a href="{{ route('newsletter-list-villa') }}"><i class="zmdi zmdi-dot-circle-alt"></i>
                                    لیست عضوهای هر ملک</a></li>
                            <li><a href="{{ route('newsletter-list-blog') }}"><i class="zmdi zmdi-dot-circle-alt"></i>
                    ...
                    <li class="">
                        ...
                        <li class="">
                            ...
                            <ul class="mm-collapse" style="height: 2px;">
                                ...
                                <li><a href="{{ route('settings.index') }}"><i class="zmdi zmdi-dot-circle-alt"></i>تنظیمات سایت </a></li>
    ...
    <header class="topbar-nav">
        <nav class="navbar navbar-expand fixed-top">
            ...
            <ul class="navbar-nav align-items-center right-nav-link ml-auto">
                ...
                <li class="nav-item dropdown dropdown-lg">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative"
                       href="{{route('notification-list')}}">
                        ...
                        @php $notifications=\App\Notification::where('user_id',auth()->id())->where('seen',0)->count(); @endphp
                        @if($notifications>0)
                        <span class="bg-info text-white badge-up">{{ $notifications  }}</span>
                        @endif
                    </a>
                </li>
                <li class="nav-item dropdown dropdown-lg">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        @php $wallet=\App\Wallet::where('user_id',auth()->id())->first() @endphp
                                ...
                                <a href="">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="msg-info">دلار {{$wallet?number_format($wallet->dollar):0}}</p>
                                        </div>
                                    </div>
                                </a>
                            </li>
                                ...
                                <a href="">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="msg-info">ریال {{$wallet?number_format($wallet->rial):0}}</p>
                                        </div>
                                    </div>
                                </a>
                            </li>
                                ...
                                <a href="">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="msg-info">لیر {{$wallet?number_format($wallet->lira):0}}</p>
                                        </div>
                                    </div>
                                </a>
                            </li>
                                ...
                                <a href="">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="msg-info">یورو {{$wallet?number_format($wallet->euro):0}}</p>
                                        </div>
                                    </div>
                                </a>
                            </li>
                            <li class="list-group-item text-center">
                                <a href="{{route('transaction-list')}}">مشاهده تراکنش ها</a>
                            </li>
                        </ul>
                    </div>
                </li>
                    ...
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" data-toggle="dropdown"
                       href="javascript:void(0);">
                        <i class="zmdi zmdi-notifications-active align-middle"></i><span
                                class="bg-info text-white badge-up">{{ count($pending_users)+$notifications+count(\App\User::where('refer_id',auth()->id())->get()) }}</span></a>
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            @foreach($pending_users as $pending_user)
                                <li class="list-group-item">
                                    <a href="{{ route('user-show', [$pending_user->id,url()->current()]) }}">
                                        <div class="media">
                                            <i class="zmdi zmdi-accounts fa-2x mr-3 text-info"></i>
                                            <div class="media-body">
                                                <h6 class="mt-0 msg-title">در انتظار تایید</h6>
                                                <p class="msg-info">{{ $pending_user->first_name . ' ' . $pending_user->last_name }}</p>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                            @endforeach
                            <li class="list-group-item text-center"><a href="{{ route('user-pending-list') }}">مشاهده
                                    همه کاربران در انتظار</a></li>
                        </ul>
                        @endif
                        @if(count(\App\User::where('refer_id',auth()->id())->get()))
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                مشتریان شما
                            </li>
                            @foreach(\App\User::where('refer_id',auth()->id())->get() as $user)
                                <li class="list-group-item">
                                    <a href="">
                                        <div class="media">
                                            <i class="zmdi zmdi-accounts fa-2x mr-3 text-info"></i>
                                            <div class="media-body">
                                                ...
                                                <p class="msg-info">{{ $user->first_name . ' ' . $user->last_name }}</p>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                            @endforeach
                            <li class="list-group-item text-center">
                                <a href="{{ route('user-refer-list') }}">مشاهده ارجاع شده</a>
                            </li>
                        </ul>
                        @endif
                        @if(count(\App\Notification::where('user_id',auth()->id())->where('seen',0)->get()))
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    نوتیفیکیشن ها
                                </li>
                                @foreach(\App\Notification::where('user_id',auth()->id())->get() as $notifiy)
                                    <li class="list-group-item">
                                        <a href="{{route('notification-show',$notifiy->id)}}">
                                            <div class="media">
                                                <i class="zmdi zmdi-money-box fa-2x mr-3 text-info"></i>
                                                <div class="media-body">
                                                    <h6 class="mt-0 msg-title">{{$notifiy->message}}</h6>
                                                    {{--                                                <p class="msg-info">{{ $user->first_name . ' ' . $user->last_name }}</p>--}}
                                                </div>
                                            </div>
                                        </a>
                ...
                @php $refers=\App\User::where('refer_id',auth()->id())->where('referred',1)->where('reserved',0)->get(); @endphp
                @role('مدیر ملک')
                <li class="nav-item dropdown dropdown-lg">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" data-toggle="dropdown"
                       href="javascript:void(0);">
                        <i class="zmdi zmdi-notifications-active align-middle"></i>
                        @if(count($refers)+$notifications>0)
                        <span class="bg-info text-white badge-up">{{ count($refers)+$notifications }}</span>
                        @endif
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        @if(count($refers))
                            <ul class="list-group list-group-flush">
                                ...
                                @endforeach
                                <li class="list-group-item text-center">
                                    <a href="{{ route('user-pending-list') }}">مشاهده همه کاربران در انتظار</a>
                                </li>
                            </ul>
                        @endif
                        @if(count(\App\Notification::where('user_id',auth()->id())->where('seen',0)->get()))
                    ...
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" data-toggle="dropdown"
                       href="javascript:void(0);">
                        <span class="user-profile">
                            <img src="{{auth()->user()->photo ? url(auth()->user()->photo->path) : url('assets/admin/pic/avatar-13.png')}}"
                                 class="img-circle"
                                 alt="user avatar">
                        </span>
                    </a>
                            ...
                            <a href="{{ route('profile-show', Auth::user()->id) }}">
                                <div class="media">
                                    <div class="avatar"><img class="align-self-start mr-3"
                                                             src="{{auth()->user()->photo ? url(auth()->user()->photo->path) : url('assets/admin/pic/avatar-13.png')}}"
                                                             alt="user avatar"></div>
                                    <div class="media-body">
...
<script src="{{url('assets/admin/js/jquery_002.js')}}"></script>
<script src="{{url('assets/admin/js/popper.js')}}"></script>
<script src="{{url('assets/admin/js/bootstrap.js')}}"></script>

<!-- simplebar js -->
<script src="{{url('assets/admin/js/simplebar.js')}}"></script>
<!-- Metismenu js -->
<script src="{{url('assets/admin/js/metisMenu.js')}}"></script>
<!-- loader scripts -->
<script src="{{url('assets/admin/js/jquery.js')}}"></script>
...
<!-- Custom scripts -->
<script src="{{url('assets/admin/js/app-script.js?v=').time()}}"></script>
<!-- Chart js -->

<script src="{{url('assets/admin/js/Chart.js')}}"></script>
<!-- Vector map JavaScript -->
<script src="{{url('assets/admin/js/jquery-jvectormap-2.js')}}"></script>
<script src="{{url('assets/admin/js/jquery-jvectormap-world-mill-en.js')}}"></script>
<!-- Easy Pie Chart JS -->
<script src="{{url('assets/admin/js/jquery_004.js')}}"></script>
<!-- Sparkline JS -->
<script src="{{url('assets/admin/js/jquery.js')}}"></script>
<script src="{{url('assets/admin/js/excanvas.js')}}"></script>
<script src="{{url('assets/admin/js/jquery_003.js')}}"></script>
<!-- Chosen -->
<script src="{{ url('assets/admin/chosen/js.js')}}"></script>
<script type="text/javascript" src="{{ url('assets/admin/js/jgrowl.min.js') }}"></script>
...
@endif
{{--<script type="text/javascript" src="{{ url('assets/admin/js/translator.js') }}"></script>--}}
</body>
</html>
