    ...
    @slot('body')
        <div class="card">
            ...
            <div class="card-body">
                <div class="row gallery">
                    @foreach($gallery->photo as $photo)
                        <div class="col-md-3">
                            ...
                            {!! Form::open(['method' => 'DELETE', 'route' => ['location-gallery-photo-destroy', $photo->id] ]) !!}
                ...
                {{ Form::open(array('route' => 'location-gallery-photo-store', 'method' => 'PUT', 'files' => true)) }}
                {{ Form::hidden('gallery', $gallery->id) }}
                <div class="form-group">
                    {{ Form::label('name', 'تصویر جدید') }}
