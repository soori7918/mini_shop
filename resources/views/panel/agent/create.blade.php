    ...
    @slot('body')
        <div class="card" dir="rtl">
            <div class="card-header archive-card-header">
                ...
                <div class="card-body">
                    {{ Form::open(array('route' => 'agent.store', 'method' => 'POST', 'files' => true, 'style' => 'width:100%!important;min-width:100%!important')) }}
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                {{ Form::textarea('description', '', array('id' => 'body', 'class' => 'form-control textarea')) }}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
