@component('layouts.back')
    ...
    @slot('body')
        <div class="card">
            ...
            <div class="card-body">
                {{ Form::model($gallery, array('route' => array('gallery-update', $gallery->id), 'method' => 'PATCH')) }}
                <div class="form-group">
                    {{ Form::label('villa_id', 'ویلا') }}
                    {{ Form::select('villa_id', array_pluck($villas, 'name', 'id'), null, array('class' => 'form-control selectpicker')) }}
                </div>
                <div class="form-group">
                    {{ Form::label('name', 'نام') }}
