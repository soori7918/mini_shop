@component('layouts.back')
    ...
    @slot('body')
        <div class="card text-center" dir="rtl">
            ...
            <div class="card-body">
                <div class="post">
                    {{ Form::open(array('route' => 'slider-update', 'method' => 'patch', 'files' => true)) }}
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6" hidden>
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control">
                                    <option value="1" @if($slider->type == 1) selected @endif>موبایل</option>
                                    <option value="2" @if($slider->type == 2) selected @endif>دکستاپ</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" style="margin-top: 10px;">
                            <div class="form-group">
                               ...
                               <img src="{{$slider->photo?url($slider->photo->path):''}}" height="150px">
                            </div>
                        </div>
                    </div>
                    <br/>
