@component('layouts.back')
    @slot('title') ویرایش {{ $title }} {{ $villa->name }} @endslot
    @slot('body')
        <style>
            .price_input {
                padding-right: 35px;
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{ Form::hidden('latitude', $villa->latitude, array('id' => 'latitude')) }}
                {{ Form::hidden('longitude', $villa->longitude, array('id' => 'longitude')) }}
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" name="category_id" id="category_id">
                                ...
                                @foreach($categories as $category)
                                    <option
                                            value="{{ $category->id }}" {{ old('category_id', $villa->category_id) == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            ...
                            {{ Form::select('type_villa', App\Villa::types_villa(), null, array('class' => 'form-control selectpicker')) }}
                        </div>
                    </div>
                </div>
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select select_js state_id " name="state_id" id="state_id" data-type="state_id" data-reply="city_id" data-name="شهر">
                                    ...
                                    @foreach($states as $city)
                                        <option data-target=".cityId{{$city->id}}" value="{{ $city->id }}"{{ old('state_id') == $city->id ? 'selected' : '' }}{{ $villa->state_id == $city->id ? 'selected' : '' }}>{{ $city->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select select_js city_id" name="city_id" id="city_id" data-type="city_id" data-reply="zone_id" data-name="منطقه">
                                    ...
                                    @foreach($cities as $city)
                                        <option data-target=".cityId{{$city->id}}" value="{{ $city->id }}"{{ old('city_id') == $city->id ? 'selected' : '' }}{{ $villa->city_id == $city->id ? 'selected' : '' }}>{{ $city->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select  zone_id" name="zone_id" id="zone_id">
                                    ...
                                    @foreach($zones as $city)
                                        <option data-target=".cityId{{$city->id}}" value="{{ $city->id }}"{{ old('zone_id') == $city->id ? 'selected' : '' }}{{ $villa->zone_id == $city->id ? 'selected' : '' }}>{{ $city->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 col-xs-12 hide_box">
                            ...
                            <input type="text" class="form-control" name="address1"
                                   value="{{ old('address', $villa->address) }}">
                        </div>
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            ...
                            {{--                            {{ Form::select('room_num', array('1' => '1 خوابه', '2' => '2 خوابه', '3' => '3 خوابه', '4' => '4 خوابه', '5' => '5 خوابه','6' => '6 خوابه '), null, array('class' => 'form-control selectpicker')) }}--}}
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group @if($errors->has('number_of_wc')) has-danger @endif">
                            ...
                            {{--                            {{ Form::select('number_of_wc', array('1' => '1', '2' => '2', '3' => '3'), null, array('class' => 'form-control selectpicker')) }}--}}
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            ...
                            @endphp
                            {{ Form::select('kitchen', ['0'=>'اوپن','1'=>'بسته'], null, array('class' => 'form-control selectpicker')) }}
                        </div>
                    </div>
                        <div class="col-md-4 col-xs-12">
                            <div class="form-group">
                                {{ Form::label('type_sale', 'نقد/اقساط') }}
                                {{ Form::select('type_sale', ['نقد'=>'نقد','نقد/اقساط'=>'نقد/اقساط'], null, array('class' => 'form-control selectpicker')) }}
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-12">
                            <div class="form-group">
...
{{--                            {{ Form::select('salon_num', array('1' => '1 سالن', '2' => '2 سالن', '3' => '3 سالن'), null, array('class' => 'form-control selectpicker')) }}--}}
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group ">
                            ...
                            {{ Form::number('area', null, array('placeholder' => 'متراژ ', 'class' => 'form-control','min'=>1)) }}
                        </div>
                    </div>
                    {{--<div class="col-md-4 col-xs-12">--}}
                        {{--<div class="form-group ">--}}
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group @if($errors->has('floor')) has-danger @endif">
                            ...
                            {{ Form::number('floor', null, array('placeholder' => 'طبقه چندم', 'class' => 'form-control','min'=>0)) }}
                        </div>
                    </div>
                    ...
                    {{--</div>--}}
                        <div class="col-md-4 col-xs-12 hide_box">
                            <div class="form-group">
                                {{ Form::label('properties_out', 'امکانات رفاهی', array('style' => 'font-size: 10px')) }}
                                {{ Form::select('properties_out[]', array_pluck($propertiesout, 'name', 'id'), json_decode($villa->properties_out), array('class' => 'form-control selectpicker', 'multiple')) }}
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-12 hide_box">
                            <div class="form-group">
                                {{ Form::label('properties_access', 'دسترسی ها', array('style' => 'font-size: 10px')) }}
                                {{ Form::select('properties_access[]', array_pluck($propertiesaccess, 'name', 'id'), json_decode($villa->properties_access), array('class' => 'form-control selectpicker', 'multiple')) }}
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-12">
                        <div class="form-group bootstrap-selects @if($errors->has('price')) has-danger @endif">
                            {{ Form::label('price', 'قیمت') }}
                            {{ Form::text('price', null, array('class' => 'form-control text-center price_input','min'=>1)) }}

                            {{ Form::select('price_type', array('lira'=>'لیر'), null, array('class' => 'form-control selectpicker', 'style' => 'width:26%;margin-right:.2rem;float:right')) }}
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                    ...
                    <div class="col-md-4 col-xs-12 d-none">
                        <div class="form-group">
                            ...
                            {{ Form::select('villa_space', ['1'=>'Net','2'=>'Brüt'], null, array('class' => 'form-control selectpicker')) }}
                        </div>
                    </div>
                    {{--<div class="col-md-4 col-xs-12">--}}
                        {{--<div class="form-group">--}}
                    ...
                    <div class="col-md-4 col-xs-12 d-none">
                        <div class="form-group @if($errors->has('name')) has-danger @endif">
                            ...
                            {{ Form::text('whatsapp_phone', null, array('class' => 'form-control')) }}
                        </div>
                    </div>
                            ...
                            <div class="col-md-2 col-xs-12">
                                <div class="form-group @if($errors->has('name')) has-danger @endif" style="display: inline-grid !important;">
                                    ...
                                    <div class="form-control text-center">
                                        {{ Form::checkbox('rent_by_estate', null , true,array('style' => "vertical-align:middle")) }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-2 col-xs-12">
                                <div class="form-group @if($errors->has('name')) has-danger @endif" style="display: inline-grid !important;">
                                    ...
                                    <div class="form-control text-center">
                                        {{ Form::checkbox('yedki', null , $villa->yedki?true:false,array('style' => "vertical-align:middle")) }}
                                    </div>
                                </div>
                            </div>
                    ...
                    {{--                                       @if($villa->last_discount == 'yes') checked @endif>--}}
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="row w-100 mb-5">
                            ...
                            <input type="file" class="gallery-multiple gallery_1" name="gallery[]" accept="image/*" multiple="">
                            <div class="gallery-preview gallery_preview_1 ui-sortable">
                        ...
                        <div class="row w-100 mb-5">
                            <label class="ml-3">نمای داخلی</label>
                            <input type="file" class="gallery-multiple gallery_2" name="in_gallery[]" accept="image/*" multiple="">
                            <div class="gallery-preview gallery_preview_2 ui-sortable">
                                @foreach($villa->in_gallery as $photo)
                                    <div class="gallery-item" data-id="{{ $photo->id }}">
                                        <div class="gallery-delete">x</div>
                                        <img src="{{ url($photo->path) }}">
                                    </div>
                        ...
                        <div class="row w-100 mb-5">
                            <label class="ml-3">نمای خارجی</label>
                            <input type="file" class="gallery-multiple gallery_3" name="out_gallery[]" accept="image/*" multiple="">
                            <div class="gallery-preview gallery_preview_3 ui-sortable">
                                @foreach($villa->out_gallery as $photo)
                                    <div class="gallery-item" data-id="{{ $photo->id }}">
                                        <div class="gallery-delete">x</div>
                                        <img src="{{ url($photo->path) }}">
                                    </div>
                        ...
                        <div class="row w-100 mb-5">
                            <label class="ml-3">پلن ها</label>
                            <input type="file" class="gallery-multiple gallery_4" name="plan_gallery[]" accept="image/*" multiple="">
                            <div class="gallery-preview gallery_preview_4 ui-sortable">
                                @foreach($villa->plan_gallery as $photo)
                                    <div class="gallery-item" data-id="{{ $photo->id }}">
                                        <div class="gallery-delete">x</div>
                                        <img src="{{ url($photo->path) }}">
                                    </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            @if( $villa->category_id!='' or $villa->category_id!=null)
            $('.hide_box').hide()
            @endif
        </script>
    @endpush
