@component('layouts.back')
    ...
    @slot('body')
        ...
        <div class="card">
            ...
            <div class="card-body">
              <div class="container">
                  <form method="post" action="{{route('villa-category-store')}}" enctype="multipart/form-data">
                      @csrf
                      @method('post')
                      <div class="row">
                          <div class="col-lg-8">
                          ...
                          <div class="col-lg-4">
                              <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                       ...
                                       <label style="color: black;width: 100%">
                                           <input type="checkbox" value="{{$project_category->id}}"  name="project_category[]"><span class="px-2" style="color: black">{{$project_category->title}}</span>
                                       </label>
                                        @endforeach
                                    </div>
                              ...
                              <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                       ...
                                       <label style="color: black;width: 100%">
                                           <input type="checkbox" value="{{$project_property->id}}"  name="project_property[]"><span class="px-2" style="color: black">{{$project_property->name}}</span>
                                       </label>
                                        @endforeach
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                              ...
                              <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                       ...
                                       <label style="color: black;width: 100%">
                                           <input type="checkbox" value="{{$city->id}}"  name="city[]"><span class="px-2" style="color: black">{{$city->name}}</span>
                                       </label>
                                        @endforeach
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                              ...
                              <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                        @foreach($cities as $city)
                                            <label style="color: black;width: 100%">
                                                <input type="checkbox" value="{{$city->id}}"  name="neighberhood[]"><span class="px-2" style="color: black">{{$city->name}}</span>
                                            </label>
                                        @endforeach
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                              ...
                              <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                        @foreach($contries as $country)
                                            <label style="color: black;width: 100%">
                                                <input type="checkbox" value="{{$country->id}}"  name="country[]"><span class="px-2" style="color: black">{{$country->fa_name}}</span>
                                            </label>
                                        @endforeach
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
