@component('layouts.back')
    @slot('title') افزودن {{ 'پروژه' }} @endslot
    @slot('body')
        <style>
            .singel{
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="container">
                    <form method="post" action="{{route('villa-category-update', $project->id)}}" enctype="multipart/form-data" files="true">
                        @csrf
                        @method('patch')
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <input type="text" class="form-control" name="project_code" value="{{ $project->code }}" placeholder="عنوان">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="title">عنوان</label>
                                        <input type="text" class="form-control" name="title"  value="{{ $project->title}}" placeholder="عنوان">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="slug">اسلاگ</label>
                                        <input type="text" class="form-control" name="slug"  value="{{  $project->slug}}" >
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="keyword">کلمات کلیدی</label>
                                        <input type="text" class="form-control" name="keyword"  value="{{ $project->keyword}}" >
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="price_label">لیبل پشت قیمت</label>
                                        <input type="text" class="form-control" name="price_label"  value="{{  $project->project_label}}" >
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="start_price">شروع قیمت از (لیر)</label>
                                        <input type="text" class="form-control" name="start_price"   value="{{ $project->start_price}}">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="total">تعداد کل اتاق</label>
                                        <input type="text" class="form-control" name="total"  value="{{$project->total}}" placeholder="">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="bedroom">تعداد اتاق خواب</label>
                                        <input type="text" class="form-control" name="bedroom"  value="{{$project->bedroom}}" placeholder="">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="bathroom">تعداد حمام</label>
                                        <input type="text" class="form-control" name="bathroom"  value="{{$project->bathroom}}" placeholder="">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="activity">کلاس انرژی</label>
                                        <input type="text" class="form-control" name="activity"  value="{{$project->activity}}" placeholder="">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="area">مساحت پروژه</label>
                                        <input type="text" class="form-control" name="area" placeholder="" value="{{ $project->area}}">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="wc_count">تعداد سرویس بهداشتی</label>
                                        <input type="text" class="form-control" name="wc_count" placeholder=""  value="{{$project->wc_count}}">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="count_all_unit">تعداد کل واحدها</label>
                                        <input type="text" class="form-control" name="count_all_unit" placeholder=""  value="{{ $project->count_all_unit}}">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="count_sale_unit">تعداد واحد های فروش رفته</label>
                                        <input type="text" class="form-control" name="count_sale_unit" placeholder="" value="{{$project->count_sale_unit}}">
                                    </div>
                                    <div class="col-lg-12 form-group">
                                        <label for="short_description">توضیحات مختصر</label>
                                        <textarea class="form-control " id="short_description" name="short_description" >{{$project->short_description}}</textarea>
                                    </div>
                                    <div class="col-lg-12 form-group">
                                        <label for="description">توضیحات پروژه</label>
                                        <textarea class="form-control textarea" id="description" name="description" >{!! $project->description !!}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                        @foreach($project_categories as $project_category)
                                            <label style="color: black;width: 100%">
                                                <input type="checkbox" {{in_array($project_category->id,$selected_project_categorys) ? 'checked' : ''}} value="{{$project_category->id}}"  name="project_category[]"><span class="px-2" style="color: black">{{$project_category->title}}</span>
                                            </label>
                                        @endforeach
                                    </div>
                                ...
                                <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                        @foreach($propertiesout as $project_property)
                                            <label style="color: black;width: 100%">
                                                <input type="checkbox" {{in_array($project_property->id,$selected_project_propertys) ? 'checked' : ''}} value="{{$project_property->id}}"  name="project_property[]"><span class="px-2" style="color: black">{{$project_property->name}}</span>
                                            </label>
                                        @endforeach
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                                ...
                                <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                        @foreach($cities1 as $city)
                                            <label style="color: black;width: 100%">
                                                <input type="checkbox" value="{{$city->id}}" {{in_array($city->id,$selected_project_citys) ? 'checked' : ''}}   name="city[]"><span class="px-2" style="color: black">{{$city->name}}</span>
                                            </label>
                                        @endforeach
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                                ...
                                <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                        @foreach($cities as $city)
                                            <label style="color: black;width: 100%">
                                                <input type="checkbox" value="{{$city->id}}"  {{in_array($city->id,$selected_project_citys) ? 'checked' : ''}} name="neighberhood[]"><span class="px-2" style="color: black">{{$city->name}}</span>
                                            </label>
                                        @endforeach
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                                ...
                                <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                        @foreach($contries as $country)
                                            <label style="color: black;width: 100%">
                                                <input type="checkbox" value="{{$country->id}}" {{in_array($country->id,$selected_project_countrys)  ? 'checked' : ''}} name="country[]"><span class="px-2" style="color: black">{{$country->fa_name}}</span>
                                            </label>
                                        @endforeach
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                                ...
                                <div class="card bg-dark p-2 text-white w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body">
                                        <select class="form-control" name="status">
                                            <option value="">انتخاب کنید</option>
                                            <option value="published" {{$project->status == "published" ? 'selected' : ''}}>فعال</option>
                                            <option value="pending" {{$project->status == "pending" ? 'selected' : ''}}>در انتظار تایید</option>
                                        </select>
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                                </div>
