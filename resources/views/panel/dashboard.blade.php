...
{{--                        <span class="share-to" >--}}
{{--                        <input class="form-control text-center" type="text" id="share_link" value="{{ route('front.register.office', ['ref' => auth()->user()->code]) }}">--}}
{{--                        </span>--}}
{{--                        <br>--}}
...
{{--                    </div>--}}
                    ...
                    <div class="card-content">
                        <div class="row row-group m-0">
                            <div class="col-12 border-light">
                                <div class="card-body">
                                    <h5 class="text-white mb-0">{{ $users_count }}
                                        <span style="font-size: 12px">(مشتری)</span>
                                        <span class="float-right"><i class="fa fa-user"></i></span></h5>
                                    <a href="{{ route('user-list') }}?type=myCustomers" class="mb-0 text-white small-font">لیست همه
                                        مشتریان</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-group m-0">
                            <div class="col-12 border-light">
                                <div class="card-body">
                                    ...
                                    @if(auth()->user()->hasRole('مدیر') || auth()->user()->hasRole('مدیر ملک') || auth()->user()->hasRole('call center') || auth()->user()->hasRole('call center(sales)'))
                                    <a href="{{ route('villa-list','published') }}" class="mb-0 text-white small-font">لیست همه
                                        ملکها</a>
                                    @endif
                                </div>
                            </div>
            ...
            <div class="col-md-4">
                <div class="card mt-3 ">
                    <div class="card-content">
                        <div class="row row-group m-0">
                            <div class="col-12 border-light {{$refers_count>0?'bg-danger':''}}">
                                <div class="card-body">
                                    <h5 class="text-white mb-0">{{ $refers_count }}
                                        <span style="font-size: 12px">(ارجاع)</span>
                                        <span class="float-right"><i class="fa fa-share-square"></i></span></h5>
                                    @if(auth()->user()->hasRole('مدیر') || auth()->user()->hasRole('مدیر ملک') || auth()->user()->hasRole('call center') || auth()->user()->hasRole('call center(sales)'))
                                    <a href="{{ route('user-refer-list') }}" class="mb-0 text-white small-font">لیست همه
                                        ارجاعات</a>
                                    @endif
                                </div>
                            </div>
        ...
        <div class="card mt-3 {{auth()->user()->account_status!='active'?'':'d-none'}}">
            <div class="card-content">
                <div class="row row-group m-0">
                        ...
                        <div class="card-body p-5">
                            <div class="alert alert-danger px-4 py-3 text-center" role="alert">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    @if(in_array('fname_en',$editables))
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" {{in_array('fname_en',$editables)?'checked':''}}>نام (انگلیسی)
                                        </label>
                                    </div>
                                    @endif
                                    @if(in_array('lname_en',$editables))
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" {{in_array('lname_en',$editables)?'checked':''}}>نام خانوادگی (انگلیسی)
                                        </label>
                                    </div>
                                    @endif
                                    @if(in_array('father_name',$editables))
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" {{in_array('father_name',$editables)?'checked':''}}>نام پدر
                                        </label>
                                    </div>
                                    @endif
                                    @if(in_array('gender',$editables))
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" {{in_array('gender',$editables)?'checked':''}}>جنسیت
                                        </label>
                                    </div>
                                    @endif
                                    @if(in_array('living_country',$editables))
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" {{in_array('living_country',$editables)?'checked':''}}>کشور در حال زندگی
                                        </label>
                                    </div>
                                    @endif
                                    @if(in_array('nationality',$editables))
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" {{in_array('nationality',$editables)?'checked':''}}>ملیت
                                        </label>
                                    </div>
                                    @endif
                                    @if(in_array('Job',$editables))
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" {{in_array('Job',$editables)?'checked':''}}>شغل
                                        </label>
                                    </div>
                                    @endif
                                    @if(in_array('ncode',$editables))
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" {{in_array('ncode',$editables)?'checked':''}}>کدملی/شماره پاسپورت
                                        </label>
                                    </div>
                                    @endif
                                    @if(in_array('postal_address',$editables))
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" {{in_array('postal_address',$editables)?'checked':''}}>آدرس
                                        </label>
                                    </div>
                                    @endif
                                    @if(in_array('address_pic',$editables))
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="address_pic" {{in_array('address_pic',$editables)?'checked':''}}>پروف آدرس
                                        </label>
                                    </div>
                                    @endif
                                    @if(in_array('passport_pic',$editables))
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="passport_pic" {{in_array('passport_pic',$editables)?'checked':''}}>پروف پاسپورت
                                        </label>
                                    </div>
                                    @endif
                                </div>
                                <a class="btn btn-primary mt-3"
                                   href="{{ route('profile-edit', auth()->user()->id) }}">ویرایش اطلاعات</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row {{auth()->user()->account_status!='active'?'d-none':''}}">
                    ...
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item bg-transparent">
                                <div class="media align-items-center">
                                    <img src="{{asset('dashboard/avatar-13.png')}}" alt="user avatar"
                            ...
                            <li class="list-group-item bg-transparent">
                                <div class="media align-items-center">
                                    <img src="{{asset('dashboard/avatar-15.png')}}" alt="user avatar"
                                         class="customer-img rounded-circle">
                                    <div class="media-body ml-3">
                            ...
                            <li class="list-group-item bg-transparent">
                                <div class="media align-items-center">
                                    <img src="{{asset('dashboard/avatar-14.png')}}" alt="user avatar"
                                         class="customer-img rounded-circle">
                                    <div class="media-body ml-3">
                            ...
                            <li class="list-group-item bg-transparent">
                                <div class="media align-items-center">
                                    <img src="{{asset('dashboard/avatar-16.png')}}" alt="user avatar"
                                         class="customer-img rounded-circle">
                                    <div class="media-body ml-3">
                            ...
                            <li class="list-group-item bg-transparent">
                                <div class="media align-items-center">
                                    <img src="{{asset('dashboard/avatar-17.png')}}" alt="user avatar"
                                         class="customer-img rounded-circle">
                                    <div class="media-body ml-3">
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush table-borderless">
                                ...
                                <tr>
                                    <td>Iphone 5</td>
                                    <td><img src="{{asset('dashboard/01.png')}}" class="product-img" alt="product img">
                                    </td>
                                    <td>#9405822</td>
                                    <td>$ 1250.00</td>
                                    <td>03 Aug 2017</td>
                                ...
                                <tr>
                                    <td>Earphone GL</td>
                                    <td><img src="{{asset('dashboard/02.png')}}" class="product-img" alt="product img">
                                    </td>
                                    <td>#9405820</td>
                                    <td>$ 1500.00</td>
                                    <td>03 Aug 2017</td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset('dashboard/03.png')}}" class="product-img" alt="product img">
                                    </td>
                                    <td>#9405830</td>
                                    <td>$ 1400.00</td>
                                    <td>03 Aug 2017</td>
                                ...
                                <tr>
                                    <td>Clasic Shoes</td>
                                    <td><img src="{{asset('dashboard/04.png')}}" class="product-img" alt="product img">
                                    </td>
                                    <td>#9405825</td>
                                    <td>$ 1200.00</td>
                                    <td>03 Aug 2017</td>
                                ...
                                <tr>
                                    <td>Hand Watch</td>
                                    <td><img src="{{asset('dashboard/05.png')}}" class="product-img" alt="product img">
                                    </td>
                                    <td>#9405840</td>
                                    <td>$ 1800.00</td>
                                    <td>03 Aug 2017</td>
                                ...
                                <tr>
                                    <td>Clasic Shoes</td>
                                    <td><img src="{{asset('dashboard/06.png')}}" class="product-img" alt="product img">
                                    </td>
                                    <td>#9405825</td>
                                    <td>$ 1200.00</td>
                                    <td>03 Aug 2017</td>
