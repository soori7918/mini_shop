            ...
            <div class="card-body">
                <div class="row mt-4 mb-4">
                    ...
                    <div class="col-md-4 post">
                        @if($post->photo)
                            <img src="{{ url($post->photo) }}" alt="{{ $post->title }}" width="250px">
                        @endif
                        <ul class="list-group mt-3">
                            <li class="list-group-item"><strong>ثبت کننده : </strong>{{ $post->user->first_name }} {{ $post->user->last_name }}</li>
                ...
                <a href="{{ route('article-edit', $post->id) }}" class="btn btn-rounded btn-success float-left mr-1"><i class="fa fa-edit ml-1"></i>ویرایش</a>
            </div>
        </div>
    @endslot
@endcomponent