@component('layouts.back')
    ...
    @slot('body')
        <div class="card text-center" dir="rtl">
            ...
            <div class="card-body">
                <div class="post">
                    {{ Form::open(array('route' => 'faq-update', 'method' => 'patch', 'files' => true)) }}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                {{ Form::label('question', 'سوال') }}
                                {{ Form::textarea('question', $item->question, array('class' => 'form-control')) }}
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                {{ Form::label('answer', 'جواب') }}
                                {{ Form::textarea('answer', $item->answer, array('class' => 'form-control')) }}
                            </div>
                        </div>
