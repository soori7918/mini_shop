                    ...
                    <table class="archive-table has-lines">
                        ...
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($item->expert?$item->expert->first_name:'نا مشخص'); ?> <?php echo e($item->expert?$item->expert->last_name:''); ?></td>
                                <td><?php echo e($item->total); ?></td>
                                <td>
                                    <div class="d-flex">

                                                <a href="<?php echo e($item->expert? route('user-show', $item->expert->id):'#'); ?>" class="btn btn-sm btn-warning mr-1"><i class="fa fa-eye ml-1"></i>مشاهده</a>
