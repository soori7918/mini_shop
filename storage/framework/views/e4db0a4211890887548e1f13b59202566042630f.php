...
<head>
    <title><?php echo e(isset($title) ? $title : 'استانبول سرویس'); ?></title>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6Le-SsIUAAAAABBpNNOoWew8QWpLvphUpD-Jxr0t"></script>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <span style="padding-right: 3px;">قبلا در استانبول سرویس ثبت نام نکرده اید؟</span><a
        ...
        <nav style="direction: ltr" class="navbar navbar-expand-lg navbar-light bg-light nav-mobile">
            <?php if(Auth::user()): ?>
                <a class="navbar-brand"
                   href="<?php echo e(route('front-favorites-list')); ?>"><?php echo e(Auth::user()->first_name . ' ' . Auth::user()->last_name); ?></a>
            <?php else: ?>
            ...
            <nav class="nav">
                <div class="container">
                    ...
                    <div class="flipInX  animated">
                        ...
                        <?php if(Auth::user()): ?>
                            <a style=" position: absolute;width: 182px;color: white;right: 30px;top: 20px;z-index: 10000; font-size: 10px; max-width: 50px; text-align: center"
                        ...
                        <?php else: ?>
                            ...
                            <a class="animation-ticket"
                               style=" position: absolute;width: 182px;color: white;right: 35px;top: 13px;z-index: 10000; max-width: 50px"
                               data-toggle="modal" data-target="#myModal"><span
                                        style="margin-right: 9px">ورود</span></a>
                    ...
                    <ul style="margin-top: 6%" class="float-right m-right-9" data-direction="rtl">
                        ...
                        <li>
                            <a href="<?php echo e(route('front-location-index')); ?>"><i
                                        class="nc-icon location_pin ml-2 mtp-1"></i>اجاره ملک</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><i class="nc-icon design_image ml-2 mtp-1"></i>&#1711;&#1588;&#1578;&nbsp&#1607;&#1575;&#1740;
                                &#1578;&#1601;&#1585;&#1740;&#1581;&#1740;</a>
                    ...
                    <ul style="margin-top: 6%;  <?php if(auth()->guard()->check()): ?> margin-left: 6% <?php endif; ?>"
                        ...
                        data-direction="rtl">
                        <li>
                            <a href="<?php echo e(route('front-blog')); ?>"><i class="nc-icon files_paper ml-2 mtp-1"></i>جاذبه های
                                استانبول</a>
                        </li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 mb-5 text-center">
                            <img style="width: 200px" src="<?php echo e(asset('uploads/file/1398-08-21/photos/istanbul2.png')); ?>"
                                 alt="logo"/>
                        </div>
                        <span class="col-md-2"></span>
                        <div class="col-md-2">
                            <h5>محله های استانبول</h5>
                            <ul class="footer-ul">
                                <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="<?php echo e(route('front-location-show', $location->url)); ?>"><?php echo e($location->name); ?></a>
                                    </li>
                        ...
                        <div class="col-md-3">
                            ...
                            <ul class="footer-ul">
                                <?php $__currentLoopData = $post_lastest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="<?php echo e(route('front-blog-show', $post->slug)); ?>"><?php echo e($post->title); ?></a>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-3 footer-ul">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="<?php echo e(route('front-about')); ?>">&#1587;&#1608;&#1575;&#1604;&#1575;&#1578;
                                        &#1662;&#1585;
                                        &#1578;&#1705;&#1585;&#1575;&#1585;</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('front-blog')); ?>">دانستنی های استانبول</a>
                                </li>
                                <li>
                    ...
                    <div class="row footer-bottom">
                        ...
                        <div class="col-md-6 text-center">
                            ...
                            <ul class="social">
                                ...
                                <li><a href="https://wa.me/989121031355"><i
                                                class="fa fa-whatsapp kio_sst" style="color: white"></i></a>
                        ...
                        <div style="margin-top: -1%;padding-right: 12%" class="col-md-12">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <ul>
                                        ...
                                        <li class="float-left w-100" data-direction="rtl"
                                            style="line-height: 2;padding: 6px;font-size: 12px">
                                            <span>آدرس :</span>
                                            <span>تهران ، بلوار آیت اله کاشانی ، خیابان بهمنی نژاد ، ساختمان شماره 15 ، روبروی باشگاه پرسپولیس ،واحد 1</span>
                                        </li>
                                    </ul>
                            ...
                            <div class="row text-center">
                                <div class="copyright">
                                    ...
                                    <span> | </span>
                                    <a class="company" rel="nofollow" target="_blank" href="https://adib-it.com" style="color: white">
                                        <span class="company-name">شرکت ادیب گستر عصرنوین</span>
                                        <span class="company-site">adib-it.com</span>
                                    </a>
                                </div>
                            </div>
