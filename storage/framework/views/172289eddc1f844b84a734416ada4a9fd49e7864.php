        ...
        <div class="card text-center" dir="rtl">
            ...
            <div class="card-body">
                <div class="post">
                    ...
                    <form method="post" action="<?php echo e(route('meterage.store',$project->id)); ?>">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('room', '', array('class' => 'form-control'))); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('metrage', '', array('class' => 'form-control'))); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('price', '', array('class' => 'form-control'))); ?>
