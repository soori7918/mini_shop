    ...
    <?php $__env->slot('body'); ?>
        <div class="card">
            ...
            <div class="card-body">
                <div class="row gallery">
                    <?php $__currentLoopData = $gallery->photo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-3">
                            ...
                            <?php echo Form::open(['method' => 'DELETE', 'route' => ['location-gallery-photo-destroy', $photo->id] ]); ?>
                ...
                <?php echo e(Form::open(array('route' => 'location-gallery-photo-store', 'method' => 'PUT', 'files' => true))); ?>

                <?php echo e(Form::hidden('gallery', $gallery->id)); ?>

                <div class="form-group">
                    <?php echo e(Form::label('name', 'تصویر جدید')); ?>
