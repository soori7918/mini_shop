            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="type" id="type">
                        <option <?php echo e($location->type==0?'selected':''); ?> value="0">خیر</option>
                        <option <?php echo e($location->type==1?'selected':''); ?> value="1">بله</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    <?php echo e(Form::label('name', 'نام ناحیه')); ?>

                    <?php echo e(Form::text('name', $location->name, array('placeholder' => 'تهران, ایران', 'class' => 'form-control'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::textarea('body', null, array('id' => 'body', 'class' => 'form-control textarea','placeholder'=>'توضیحات تکمیلی', 'rows' => 5))); ?>
