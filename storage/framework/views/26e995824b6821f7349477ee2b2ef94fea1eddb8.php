<?php $__env->startComponent('layouts.back'); ?>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" name="category_id" id="category_id">
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option
                                            value="<?php echo e($category->id); ?>" <?php echo e(old('category_id', $villa->category_id) == $category->id ? 'selected' : ''); ?>><?php echo e($category->name); ?></option>
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('type_villa', App\Villa::types_villa(), null, array('class' => 'form-control selectpicker'))); ?>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select select_js state_id " name="state_id" id="state_id" data-type="state_id" data-reply="city_id" data-name="شهر">
                                    ...
                                    <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option data-target=".cityId<?php echo e($city->id); ?>" value="<?php echo e($city->id); ?>"<?php echo e(old('state_id') == $city->id ? 'selected' : ''); ?><?php echo e($villa->state_id == $city->id ? 'selected' : ''); ?>><?php echo e($city->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select select_js city_id" name="city_id" id="city_id" data-type="city_id" data-reply="zone_id" data-name="منطقه">
                                    ...
                                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option data-target=".cityId<?php echo e($city->id); ?>" value="<?php echo e($city->id); ?>"<?php echo e(old('city_id') == $city->id ? 'selected' : ''); ?><?php echo e($villa->city_id == $city->id ? 'selected' : ''); ?>><?php echo e($city->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-12 hide_box">
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select  zone_id" name="zone_id" id="zone_id">
                                    ...
                                    <?php $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option data-target=".cityId<?php echo e($city->id); ?>" value="<?php echo e($city->id); ?>"<?php echo e(old('zone_id') == $city->id ? 'selected' : ''); ?><?php echo e($villa->zone_id == $city->id ? 'selected' : ''); ?>><?php echo e($city->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 col-xs-12 hide_box">
                            ...
                            <input type="text" class="form-control" name="address1"
                                   value="<?php echo e(old('address', $villa->address)); ?>">
                        </div>
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            ...
                            ?>
                            <?php echo e(Form::select('kitchen', ['0'=>'اوپن','1'=>'بسته'], null, array('class' => 'form-control selectpicker'))); ?>
                        ...
                        <div class="col-md-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('type_sale', ['نقد'=>'نقد','نقد/اقساط'=>'نقد/اقساط'], null, array('class' => 'form-control selectpicker'))); ?>
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group ">
                            ...
                            <?php echo e(Form::number('area', null, array('placeholder' => 'متراژ ', 'class' => 'form-control','min'=>1))); ?>
                    ...
                    <div class="col-md-4 col-xs-12">
                        ...
                        <div class="col-md-4 col-xs-12 hide_box">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('properties_out[]', array_pluck($propertiesout, 'name', 'id'), json_decode($villa->properties_out), array('class' => 'form-control selectpicker', 'multiple'))); ?>
                        ...
                        <div class="col-md-4 col-xs-12 hide_box">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('properties_access[]', array_pluck($propertiesaccess, 'name', 'id'), json_decode($villa->properties_access), array('class' => 'form-control selectpicker', 'multiple'))); ?>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row w-100 mb-5">
                            ...
                            <div class="gallery-preview gallery_preview_2 ui-sortable">
                                <?php $__currentLoopData = $villa->in_gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="gallery-item" data-id="<?php echo e($photo->id); ?>">
                                        <div class="gallery-delete">x</div>
                                        <img src="<?php echo e(url($photo->path)); ?>">
                                    </div>
                        ...
                        <div class="row w-100 mb-5">
                            ...
                            <div class="gallery-preview gallery_preview_3 ui-sortable">
                                <?php $__currentLoopData = $villa->out_gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="gallery-item" data-id="<?php echo e($photo->id); ?>">
                                        <div class="gallery-delete">x</div>
                                        <img src="<?php echo e(url($photo->path)); ?>">
                                    </div>
                        ...
                        <div class="row w-100 mb-5">
                            ...
                            <div class="gallery-preview gallery_preview_4 ui-sortable">
                                <?php $__currentLoopData = $villa->plan_gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="gallery-item" data-id="<?php echo e($photo->id); ?>">
                                        <div class="gallery-delete">x</div>
                                        <img src="<?php echo e(url($photo->path)); ?>">
                                    </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            <?php if( $villa->category_id!='' or $villa->category_id!=null): ?>
            $('.hide_box').hide()
            <?php endif; ?>
        </script>
    <?php $__env->stopPush(); ?>
