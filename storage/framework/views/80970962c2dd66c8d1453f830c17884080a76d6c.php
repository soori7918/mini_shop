        ...
        <div class="card">
            ...
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td width="140">
                                    <div class="btn-inline">
                                        <a href="<?php echo e(route('insurance-edit', $post->id)); ?>" class="btn btn-sm btn-info float-left mr-1"><i class="fa fa-edit ml-1"></i>ویرایش</a>
                                        <?php echo Form::open(['method' => 'DELETE', 'route' => ['insurance-destroy', $post->id] ]); ?>
                ...
                <div class="paginate p-3">
                    ...
                    <a href="<?php echo e(route('insurance-create')); ?>" class="btn btn-rounded btn-primary float-left"><i class="fa fa-circle-o ml-1"></i>افزودن</a>
                </div>
            </div>
        </div>
    <?php $__env->endSlot(); ?>
