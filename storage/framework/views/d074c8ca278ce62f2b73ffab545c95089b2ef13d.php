...
<head>
    ...
    <meta property="og:image" content="<?php echo e(url('assets/user/pic/logo.jpg')); ?>" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Place favicon.png in the root directory -->
    <link rel="shortcut icon" href="<?php echo e(url('assets/user/pic/logo.jpg')); ?>" type="image/x-icon" />
    <!-- Font Icons css -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('user/node_modules/bootstrap/dist/css/bootstrap.rtl.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('user/css/header.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('user/css/reset.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('user/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('user/css/footer.css')); ?>">
                                ...
                                <div class="col-6 col-lg-3 col-md-6">
                                    <div class="footer-text h-100 d-flex align-items-center">
                                        <div>
                                            ...
                                            <ul>
                                                <li class="">
                                                    <a href="<?php echo e(route('user.projects')); ?>">
                                ...
                                <div class="col-6 col-lg-3 col-md-6 my-media">
                                    <div class="footer-text h-100 d-flex align-items-center">
                                        <div>
                                            ...
                                            <ul>
                                                <li class="">
                                                    <a href="<?php echo e(route('user.projects.villa')); ?>">
                                                ...
                                                <li class="">
                                                    <a href="<?php echo e(route('user.projects.office')); ?>">
                                                        <p class="Answer hover-li">تجاری و هوم آفیس</p>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?php echo e(route('user.projects.consept')); ?>">
                                    ...
                                    <div class="footer-text h-100 d-flex align-items-center">
                                        <div>
                                            ...
                                            <ul>
                                                ...
                                                <li class="">
                                                    <a href="https://api.whatsapp.com/send?phone=<?php echo e($setting->whatsapp); ?>">
                                ...
                                <div class="col-6 col-lg-3 col-md-6 my-media">
                                    <div class="footer-text h-100 d-flex align-items-center">
                                        <div>
                                            ...
                                            <ul>
                                                <li class="">
                                                    <a href="<?php echo e(route('user.contact_us')); ?>">
                                                        <p class="Answer hover-li">تماس با ما</p>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?php echo e(route('user.about_us')); ?>">
                                                ...
                                                <li class="">
                                                    <a href="<?php echo e(route('user.citizenship')); ?>">
                            ...
                            <div class="pt-lg-4">
                                ...
                                <div class="mb-3 d-flex flex-wrap justify-content-end w-100">
                                    <div class="rounded-circle btn-circle border-0 bg-white d-flex align-items-center justify-content-center footer-btn-circle"><a
                                                href="<?php echo e($setting->insta); ?>"><i class="lab la-instagram text-dark"
                                                            style="font-size: 25px;padding-top: 6px"></i></a></div>
                                    <div class="rounded-circle btn-circle border-0 bg-white d-flex align-items-center justify-content-center  footer-btn-circle"><a
                                                href="<?php echo e($setting->whatsapp); ?>"><i class="lab la-whatsapp text-dark"
                                                            style="font-size: 25px;;padding-top: 6px"></i></a></div>
                                    <div class="rounded-circle btn-circle border-0 bg-white d-flex align-items-center justify-content-center  footer-btn-circle"><a
                                                href="<?php echo e($setting->facebook); ?>"><i class="lab la-facebook text-dark"
                                                            style="font-size: 25px;;padding-top: 6px"></i></a></div>
                                    <div class="rounded-circle btn-circle border-0 bg-white d-flex align-items-center justify-content-center  footer-btn-circle"><a
                                                href="<?php echo e($setting->facebook); ?>"><i class="lab la-twitter text-dark"
                                                            style="font-size: 25px;;padding-top: 6px"></i></a></div>
                                ...
                                <div class="mb-4" dir="ltr">
                                    <div class="row align-items-center justify-content-center">
                                        ...
                                        <div class="col-lg-10">
                                            <p class="text-white text-center text-lg-end"><?php echo e($setting->phone); ?></p>
                                ...
                                <div class="mb-4" dir="ltr">
                                    <div class="row align-items-center justify-content-center">
                                        ...
                                        <div class="col-lg-10">
                                            <p class="f-14 text-white text-center text-lg-end"><?php echo e($setting->address); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="<?php echo e(asset('user/node_modules/bootstrap/dist/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('user/js/map.js')); ?>"></script>
<script src="<?php echo e(asset('user/js/menu.js')); ?>"></script>
<script src="<?php echo e(asset('user/js/ani_text.js')); ?>"></script>
