<?php $__env->startComponent('layouts.back'); ?>
    ...
    <?php $__env->slot('body'); ?>
        <div class="card text-center" dir="rtl">
            ...
            <div class="card-body">
                <div class="post">
                    <?php echo e(Form::open(array('route' => 'faq-update', 'method' => 'patch', 'files' => true))); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::textarea('question', $item->question, array('class' => 'form-control'))); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::textarea('answer', $item->answer, array('class' => 'form-control'))); ?>
