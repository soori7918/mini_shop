<?php $__env->startComponent('layouts.front'); ?>
    ...
    <?php $__env->slot('body'); ?>
        ...
        <header class="header">
            <div class="container">
                <div class="header-logo" style="margin-top: -80px;margin-right: -15px;">
                    <a href="<?php echo e(url('/')); ?>"><img style="width: 200px" src="<?php echo e(url('/')); ?>/source/assets/uploads/file/1398-08-21/photos/istanbul.png"
                                                  alt="logo"/></a>
                </div>
                <div class="header-title" style="margin-top: 24vh">
                    <h1 style="margin-top: 5rem;font-size: 24px"><b>
                            هر آنچه از استانبول میخواهید ...
                        </b>
                    </h1>
                </div>
                <div class="header-destination">
                    <a href="javascript:void(0)" class="btn btn-default"> انتخاب ملک جهت اجاره بر اساس موقعیت</a>
                        ...
                        <div class="owl-carousel owl-carousel-index">
                            ...
                            <?php if(isset($like->likable->gallery->photo[0])): ?>
                                            ...
                                            <?php if($like->likable->discount): ?>
                                                <span
                                                    class="discount"><?php echo e(percent($like->likable->price, $like->likable->discount)); ?></span>
                                            <?php endif; ?>
                            </span>
        ...
        <li><strong
                class="ml-2">&#1605;&#1581;&#1604; &#1608;&#1740;&#1604;&#1575; :</strong><?php echo e($villa->district); ?></li>
        </ul>
        <ul class="icons">
        <li data-toggle="tooltip"
        ...
        <section class="whey section" style="background: url('<?php echo e($travel->background); ?>') no-repeat center fixed;">
            <div class="container">
                <div class="title text-center">
                    <h3>بهترین و مناسبترین شرایط در استانبول!</h3>
                </div>
        ...
        <section class="maps section bg-white" style="padding-bottom:0">
            <div class="container">
                <div class="title text-center">
                    <h2>ملک های اجاره ای در سطح استانبول</h2>
                </div>
                <span class="line-dot"></span>
            </div>
        ...
        <section class="information information2 section text-center">
            <div class="container">
                <div class="title text-center">
                    ...
                    <h3>آرامش خیال ، با ملک های اجاره ای استانبول سرویس</h3>
                </div>
                <span class="line-dot line-opacity"></span>
                <div class="row">
        ...
        <section class="best section">
            <div class="container">
                <div class="title text-center">
                    <h2>محبوب ترین محله های استانبول</h2>
                                                    ...
                                                    <div class="locations">
                                                        <div class="uk-panel">
                                                            <a href="<?php echo e(route('front-location-show', $location->url)); ?>">
                                                                <div
                                                                    style="width: 100%;background-size: cover;background-repeat: no-repeat;background-position: center;height: 250px;<?php if(!is_null($location->home)): ?> background-image: url('<?php echo e(url($location->home)); ?>') <?php endif; ?>"></div>
                                                                <span>
...
<p style="font-size: 15px"><?php echo e($location->slogan); ?></p>
        ...
        <section class="wheydo section bg-white">
            <div class="container">
                <div class="title text-center">
                    <h3 style="direction: rtl">استانبول سرویس؛ لوکس و منحصربه فرد، اما به صرفه!</h3>
        ...
        <section class="newslater section bg-white" data-direction="rtl">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <div class="title">
                            <h5 style="float: right;font-size: 17px">مجله استانبول سرویس</h5>
                        </div>
                        <span class="line-dot"></span>
                    ...
                    <div class="col-md-7">
                        <div class="title">
                            <h5 style="float: right;font-size: 1.3rem">دانستنی های استانبول</h5>
                        </div>
                        <span class="line-dot"></span>
                        <div class="row">
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            function initialize() {
                var latlng = new google.maps.LatLng("<?php echo e(number_format((float)41.0374971, 0, '.', '')); ?>", "<?php echo e(number_format((float)28.9674625, 0, '.', '')); ?>");
                var options = {
                    zoom: 12,
                    center: latlng,
                ...
                var locations = [
                            <?php $__currentLoopData = $villas_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $villa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ['<a href="<?php echo e(route('front-villa-show', $villa->slug)); ?>"><?php echo e($villa->name); ?></a>', <?php echo e(number_format((float)$villa->latitude, 5, '.', '')); ?>, <?php echo e(number_format((float)$villa->longitude, 5, '.', '')); ?>, 4],
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ];
