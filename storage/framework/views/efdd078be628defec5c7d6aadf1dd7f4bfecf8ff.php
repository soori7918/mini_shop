        ...
        <div class="card" dir="rtl">
            ...
            <div class="card-body">
                                ...
                                <td width="140">
                                    <?php if(!auth()->user()->hasRole('watcher')): ?>
                                        <div class="btn-inline">
                                            ...
                                            <a href="<?php echo e(route('agent.edit', $item->id)); ?>" class="btn btn-sm btn-info float-left mr-1"><i class="fa fa-edit ml-1"></i>ویرایش</a>
                                            <?php echo Form::open(['method' => 'DELETE', 'route' => ['agent.destroy', $item->id] ]); ?>
                ...
                <div class="paginate p-3">
                    ...
                    <?php if(!auth()->user()->hasRole('watcher')): ?>
                        <a href="<?php echo e(route('agent.create')); ?>" class="btn btn-rounded btn-primary float-left"><i class="fa fa-circle-o ml-1"></i>افزودن</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
