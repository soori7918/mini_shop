<?php $__env->startComponent('layouts.back'); ?>
    ...
    <?php $__env->slot('body'); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="container">
                    <form method="post" action="<?php echo e(route('villa-category-update', $project->id)); ?>" enctype="multipart/form-data" files="true">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <input type="text" class="form-control" name="project_code" value="<?php echo e($project->code); ?>" placeholder="عنوان">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="title">عنوان</label>
                                        <input type="text" class="form-control" name="title"  value="<?php echo e($project->title); ?>" placeholder="عنوان">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="slug">اسلاگ</label>
                                        <input type="text" class="form-control" name="slug"  value="<?php echo e($project->slug); ?>" >
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="keyword">کلمات کلیدی</label>
                                        <input type="text" class="form-control" name="keyword"  value="<?php echo e($project->keyword); ?>" >
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="price_label">لیبل پشت قیمت</label>
                                        <input type="text" class="form-control" name="price_label"  value="<?php echo e($project->project_label); ?>" >
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="start_price">شروع قیمت از (لیر)</label>
                                        <input type="text" class="form-control" name="start_price"   value="<?php echo e($project->start_price); ?>">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="total">تعداد کل اتاق</label>
                                        <input type="text" class="form-control" name="total"  value="<?php echo e($project->total); ?>" placeholder="">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="bedroom">تعداد اتاق خواب</label>
                                        <input type="text" class="form-control" name="bedroom"  value="<?php echo e($project->bedroom); ?>" placeholder="">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="bathroom">تعداد حمام</label>
                                        <input type="text" class="form-control" name="bathroom"  value="<?php echo e($project->bathroom); ?>" placeholder="">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="activity">کلاس انرژی</label>
                                        <input type="text" class="form-control" name="activity"  value="<?php echo e($project->activity); ?>" placeholder="">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="area">مساحت پروژه</label>
                                        <input type="text" class="form-control" name="area" placeholder="" value="<?php echo e($project->area); ?>">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="wc_count">تعداد سرویس بهداشتی</label>
                                        <input type="text" class="form-control" name="wc_count" placeholder=""  value="<?php echo e($project->wc_count); ?>">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="count_all_unit">تعداد کل واحدها</label>
                                        <input type="text" class="form-control" name="count_all_unit" placeholder=""  value="<?php echo e($project->count_all_unit); ?>">
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label for="count_sale_unit">تعداد واحد های فروش رفته</label>
                                        <input type="text" class="form-control" name="count_sale_unit" placeholder="" value="<?php echo e($project->count_sale_unit); ?>">
                                    </div>
                                    <div class="col-lg-12 form-group">
                                        <label for="short_description">توضیحات مختصر</label>
                                        <textarea class="form-control " id="short_description" name="short_description" ><?php echo e($project->short_description); ?></textarea>
                                    </div>
                                    <div class="col-lg-12 form-group">
                                        <label for="description">توضیحات پروژه</label>
                                        <textarea class="form-control textarea" id="description" name="description" ><?php echo $project->description; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                        <?php $__currentLoopData = $project_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label style="color: black;width: 100%">
                                                <input type="checkbox" <?php echo e(in_array($project_category->id,$selected_project_categorys) ? 'checked' : ''); ?> value="<?php echo e($project_category->id); ?>"  name="project_category[]"><span class="px-2" style="color: black"><?php echo e($project_category->title); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                ...
                                <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                        <?php $__currentLoopData = $propertiesout; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project_property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label style="color: black;width: 100%">
                                                <input type="checkbox" <?php echo e(in_array($project_property->id,$selected_project_propertys) ? 'checked' : ''); ?> value="<?php echo e($project_property->id); ?>"  name="project_property[]"><span class="px-2" style="color: black"><?php echo e($project_property->name); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                                ...
                                <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                        <?php $__currentLoopData = $cities1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label style="color: black;width: 100%">
                                                <input type="checkbox" value="<?php echo e($city->id); ?>" <?php echo e(in_array($city->id,$selected_project_citys) ? 'checked' : ''); ?>   name="city[]"><span class="px-2" style="color: black"><?php echo e($city->name); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                                ...
                                <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label style="color: black;width: 100%">
                                                <input type="checkbox" value="<?php echo e($city->id); ?>"  <?php echo e(in_array($city->id,$selected_project_citys) ? 'checked' : ''); ?> name="neighberhood[]"><span class="px-2" style="color: black"><?php echo e($city->name); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                                ...
                                <div class="card bg-white p-2 text-black w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                                        <?php $__currentLoopData = $contries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label style="color: black;width: 100%">
                                                <input type="checkbox" value="<?php echo e($country->id); ?>" <?php echo e(in_array($country->id,$selected_project_countrys)  ? 'checked' : ''); ?> name="country[]"><span class="px-2" style="color: black"><?php echo e($country->fa_name); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                                ...
                                <div class="card bg-dark p-2 text-white w-100 shadow-sm" style="color: black">
                                    ...
                                    <div class="card-body">
                                        <select class="form-control" name="status">
                                            <option value="">انتخاب کنید</option>
                                            <option value="published" <?php echo e($project->status == "published" ? 'selected' : ''); ?>>فعال</option>
                                            <option value="pending" <?php echo e($project->status == "pending" ? 'selected' : ''); ?>>در انتظار تایید</option>
                                        </select>
                                    </div>
                                    <a class="btn btn-primary">افزودن</a>
                                </div>
