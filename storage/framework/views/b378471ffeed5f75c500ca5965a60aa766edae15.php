    ...
    <div class="ltn__product-item ltn__product-item-4 text-center---">
        <div class="product-img">
            <?php if($villa->sale_status=='active'): ?>
                <img src="<?php echo e(url('assets/user/pic/sale1.png')); ?>" class="img_sale_png" alt="vandidad">
            <?php endif; ?>
            <a href="<?php echo e(route('user.villa.show',$villa->id)); ?>">
                <img src="<?php echo e(count($villa->photos)?url($villa->photos[0]->path):url('assets/user/pic/product.jpg')); ?>" alt="<?php echo e($villa->name); ?>">
            </a>
