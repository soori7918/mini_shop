        ...
        <div class="card">
            <div class="card-header archive-card-header">
                <div class="archive-circle-wrap">
                    ...
                    <h2><?php echo e($title); ?> <?php echo e($villa->name); ?></h2>
                </div>
            </div>
            <div class="card-body">
                <div class="row mt-4 mb-4">
                    <div class="col-md-7 post-text">
                        ...
                        <?php if(unserialize($villa->nearest) != null): ?>
                            <hr>
                            <p class="text-grey mt-5">ویلاهای نزدیک</p>
                            <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <a href="<?php echo e(route('villa-show', nearest($nearest)->id)); ?>" class="card-link float-left text-grey"><i class="fa fa-eye ml-1"></i>مشاهده</a>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-5 post">
                        ...
                        <ul class="list-group mt-3">
                            ...
                            <li class="list-group-item"><strong>نام ویلا : </strong><?php echo e($villa->name); ?></li>
                            <li class="list-group-item"><strong>محل ویلا : </strong><?php echo e($villa->location->name); ?></li>
                            <?php
                            ...
                            <li class="list-group-item"><strong>مکان ویلا : </strong>
                                <ul class="property">
                            ...
                            <li class="list-group-item"><strong>بیشترین تعداد مسافران : </strong><?php echo e($villa->max_passenger); ?></li>
                            <li class="list-group-item"><strong>تعداد اتاق : </strong><?php echo e($villa->number_of_rooms); ?></li>
                            <li class="list-group-item"><strong>تعداد خدمتکاران : </strong><?php echo e($villa->number_of_servants); ?></li>
                            <li class="list-group-item"><strong>قیمت : </strong><?php echo e($villa->price); ?> <?php if($villa->price_type == 'rial'): ?> ریال <?php elseif($villa->price_type == 'dollar'): ?> دلار <?php elseif($villa->price_type == 'euro'): ?> یورو <?php endif; ?></li>
                            <li class="list-group-item"><strong>تخفیف : </strong><?php if($villa->discount == null): ?> ندارد <?php else: ?><?php echo e($villa->discount); ?> <?php if($villa->price_type == 'rial'): ?> ریال <?php elseif($villa->price_type == 'dollar'): ?> دلار <?php elseif($villa->price_type == 'euro'): ?>
                                    یورو <?php endif; ?> <?php endif; ?></li>
                            <li class="list-group-item"><strong>تاریخ ثبت : </strong><?php echo e(my_jdate($villa->created_at, 'd F Y H:i')); ?></li>
                            <li class="list-group-item"><strong>تاریخ بروزرسانی : </strong><?php echo e(my_jdate($villa->updated_at, 'd F Y H:i')); ?></li>
                            <li class="list-group-item"><strong>وضعیت : </strong><?php if($villa->status == 'published'): ?><span class="badge badge-success">منتشر شده</span><?php elseif($villa->status == 'pending'): ?><span
                                        class="badge badge-warning">در انتظار تایید</span><?php elseif($villa->status == 'draft'): ?><span class="badge badge-secondary">پیش نویس</span><?php endif; ?></li>
                        </ul>
                    </div>
                </div>
                <br/>
                ...
                <a href="<?php echo e(route('villa-edit', $villa->id)); ?>" class="btn btn-rounded btn-success float-left mr-1"><i class="fa fa-edit ml-1"></i>ویرایش</a>
            </div>
        </div>
    <?php $__env->endSlot(); ?>
