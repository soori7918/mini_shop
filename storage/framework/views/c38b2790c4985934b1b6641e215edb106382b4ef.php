                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group <?php if($errors->has('space')): ?> has-danger <?php endif; ?>">
                            ...
                            <?php echo e(Form::text('space', null, array('placeholder' => 'فضای ویلا', 'class' => 'form-control'))); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group bootstrap-selects <?php if($errors->has('price')): ?> has-danger <?php endif; ?>">
                            ...
                            <?php echo e(Form::select('price_type', array('rial' => 'ریال', 'dollar' => 'دلار', 'euro' => 'یورو'), null, array('class' => 'form-control selectpicker', 'style' => 'width:26%;margin-right:.2rem;float:right'))); ?>
