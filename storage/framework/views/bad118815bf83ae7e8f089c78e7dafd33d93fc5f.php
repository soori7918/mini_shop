        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table class="archive-table">
                        <?php $__currentLoopData = $villas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $villa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($villa->name); ?></td>
                                <td><?php echo e($villa->category->name); ?></td>
                                <td><?php echo e($villa->location->name); ?></td>
                                <td width="140">
                                    <div class="btn-inline">
                                        <a href="<?php echo e(route('villa-show', $villa->id)); ?>" class="btn btn-sm btn-info float-left mr-1"><i class="fa fa-eye ml-1"></i>مشاهده</a>
                                        <a href="<?php echo e(route('villa-edit', $villa->id)); ?>" class="btn btn-sm btn-info float-left mr-1"><i class="fa fa-edit ml-1"></i>ویرایش</a>
                ...
                <div class="paginate p-3">
                    ...
                    <a href="<?php echo e(route('villa-create')); ?>" class="btn btn-rounded btn-primary float-left"><i class="fa fa-circle-o ml-1"></i>افزودن</a>
                </div>
            </div>
        </div>
    <?php $__env->endSlot(); ?>
