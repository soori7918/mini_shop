                ...
                <div class="row w-100-show"
                    ...
                    <div class="col-sm-12">
                        <div class="text-center">
                            ...
                            <h2 style="text-align: center">ویلر شوید</h2>
                            <hr/>
                        </div>
                    </div>
                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div style="display: flex" class="checkbox-control"><input
                                                        ...
                                                        و شرایط و قوانین</a> استفاده از سرویس های سایت ویلکسر را مطالعه
...
"><i class="fa fa-circle-o mtp-1 ml-1"></i>ثبت نام در ویلکسر
                                        </button>
                    ...
                    <div class="col-sm-12 text-center" style="padding: 24px">
                        ...
                        قبلا در ویلکسر ثبت نام کرده اید : <a style="border-bottom: 1px dashed; color: #e91e63;"
