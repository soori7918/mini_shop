    ...
    <?php endif; ?>
            <?php if(in_array($end,['jpg','jpeg']) && $service->pic): ?>
                <div class="ltn__feature-item ltn__feature-item-6 text-center p-0 <?php echo e($key==1?'active':''); ?>">
                    <img class="w-100" src="<?php echo e($service->pic?url($service->pic):url('assets/user/pic/icons/12.png')); ?>" alt="<?php echo e($service->title); ?>">
                </div>
                <?php else: ?>
                ...
                <div class="ltn__feature-icon">
                    ...
                    <img src="<?php echo e($service->pic?url($service->pic):url('assets/user/pic/icons/12.png')); ?>" alt="<?php echo e($service->title); ?>">
                </div>
