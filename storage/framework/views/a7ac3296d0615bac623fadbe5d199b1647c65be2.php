                                                ...
                                                <?php if($contact_provider->aparat): ?>
                                                    <li>
                                                        <a href="<?php echo e($contact_provider->aparat); ?>" title="Aparat">
                                                            <img src="<?php echo e(url('source/assets/user/pic/aparat_69.png')); ?>" alt="vavdidad">
                                                        </a>
                                                    </li>
                                                <?php endif; ?>
                                        </ul>
            ...
            <div class="row ltr_1200">
                <div class="col">
                    <div class="site-logo-wrap">
                        <div class="site-logo">
                            <a href="<?php echo e(route('user.index')); ?>"><img src="<?php echo e(url('source/assets/user/pic/logo.png')); ?>" alt="Logo"></a>
                        </div>
                    </div>
                </div>
...
<div class="ltn__breadcrumb-area text-left bg-overlay-white-30 bg-image "  data-bg="<?php echo e(url('source/assets/user/rtl/img/bg/14.jpg')); ?>">
