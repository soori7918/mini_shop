...
<?php $__env->startSection('styles'); ?>
    <title>لیست پروژه ها - خانه استانبول</title>
    <meta property="og:title" content="لیست پروژه ها - خانه استانبول">
                    ...
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 listing_wrapper blog2v">
                            <div class="property_listing_blog"
                                 data-link="<?php echo e(route('front.projects.show', $item->slug)); ?>">
                                <div class="blog_unit_image">
                                    <a href="<?php echo e(route('front.projects.show', $item->slug)); ?>">
                                        <?php if(count($item->photos)>0): ?>
                                            <img src="<?php echo e(url($item->photos[0]->path)); ?>" class="lazyload img-responsive wp-post-image" alt="" loading="lazy" data-original="<?php echo e($item->photo!=null?url($item->photo):''); ?>" width="525" height="328">
                                        <?php else: ?>
                                            <img src="<?php echo e($item->pic_1!=null?url($item->pic_1->path): asset('new/img/slider-1.png')); ?>" class="lazyload img-responsive wp-post-image" alt="" loading="lazy" data-original="<?php echo e($item->photo!=null?url($item->photo):''); ?>" width="525" height="328">
                                        <?php endif; ?>
                                    </a>
                                </div>
                                <h4>
                                    <a href="<?php echo e(route('front.projects.show', $item->slug)); ?>" class="blog_unit_title"><?php echo e($item->name); ?></a>
                                </h4>
                                <div class="blog_unit_meta"> <?php echo e($item->created_at); ?></div>
                                <div class="listing_details the_grid_view">
                                    ...
                                    <?php else: ?>
                                        تماس بگیرید
                                    <?php endif; ?>
                                    <a href="<?php echo e(route('front.projects.show', $item->slug)); ?>" class="unit_more_x">...</a>
                                </div>
                                <a class="read_more" href="<?php echo e(route('front.projects.show', $item->slug)); ?>">
                                    ادامه
