                ...
                <div class="table-responsive">
                    <table class="archive-table">
                        <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class=""><?php echo e($contact->name); ?></td>
                                <td class=""><?php echo e($contact->email); ?></td>
                                <td class=""><?php echo e($contact->phone); ?></td>

                                <td class=""><a data-toggle="popover" class="popover_125" title="متن پیام" data-content="<?php echo e($contact->message); ?>">متن
                                        پیام</a></td>
                                <td width="140" class="">
