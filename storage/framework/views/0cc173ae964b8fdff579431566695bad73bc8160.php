                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" name="city_id" id="city_id">
                                ...
                                <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option data-target=".cityId<?php echo e($city->id); ?>" value="<?php echo e($city->id); ?>"
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('kitchen', ['0'=>'اوپن','1'=>'بسته'], '', array('class' => 'form-control selectpicker','multiple'))); ?>
