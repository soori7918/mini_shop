...
<head>
    ...
    <title>Khaneistanbul Admin Panel</title>
    <!-- loader-->


    <!--favicon-->
    <link rel="icon"
          href="<?php echo e(asset('new/img/logo/logo-og.png')); ?>"
          type="image/x-icon">
    <!-- Vector CSS -->
        ...
        <div class="simplebar-scroll-content" style="padding-right: 17px; margin-bottom: -34px;">
            <div class="simplebar-content" style="padding-bottom: 17px; margin-right: -17px;">
                ...
                <div class="brand-logo" style="cursor: pointer">
                    <img onclick="window.open('<?php echo e(url('/')); ?>','_blank')" src="<?php echo e(asset('new/img/logo/logo-4.png')); ?>" class="logo-icon h-100 full" alt="logo icon">
                    <img onclick="window.open('<?php echo e(url('/')); ?>','_blank')" src="<?php echo e(asset('new/img/logo/logo-mini.png')); ?>" class="logo-icon h-100 mini" alt="logo icon">
                ...
                <ul class="metismenu mm-show" id="menu">
                    ...
                    <?php endif; ?>
                    <li class="">
                        <a class="" href="<?php echo e(route('complain-list')); ?>" aria-expanded="false">
                            <div class="parent-icon"><i class="zmdi zmdi-layers"></i></div>
