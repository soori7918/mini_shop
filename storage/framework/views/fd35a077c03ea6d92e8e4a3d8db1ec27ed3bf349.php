                                ...
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="<?php echo e(route('user.blog.show',$blogs->id)); ?>"><img src="<?php echo e($blogs->photo?url($blogs->photo):url('source/assets/user/rtl/img/product/1.png')); ?>" alt="#"></a>
                                        </div>
                                        ...
                                        <div class="popular-post-widget-item clearfix">
                                            <div class="popular-post-widget-img">
                                                <a href="<?php echo e(route('user.project.show',$project->id)); ?>">
                                                    ...
                                                    <?php else: ?>
                                                        <img src="<?php echo e($project->pic!=null?url($project->pic):url('source/assets/user/rtl/img/product-3/1.jpg')); ?>" alt="<?php echo e($project->name); ?>">
                                                    <?php endif; ?>
                                                </a>
                                            </div>
