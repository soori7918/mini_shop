        ...
        <div class="card text-center" dir="rtl">
            ...
            <div class="card-body">
                <div class="post">
                    ...
                    <form method="post" action="<?php echo e(route('meterage.update',[$project->id,$item->id])); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo e(Form::label('room', 'تعداد اتاق')); ?>

                                    <?php echo e(Form::text('room', $item->room, array('class' => 'form-control'))); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo e(Form::label('metrage', 'متراژ')); ?>

                                    <?php echo e(Form::text('metrage', $item->metrage, array('class' => 'form-control'))); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('price', $item->price, array('class' => 'form-control'))); ?>
