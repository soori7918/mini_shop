        ...
        <div class="card" dir="rtl">
            ...
            <div class="card-body">
                    ...
                    <table class="archive-table">
                        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($post->category?$post->category->name:'بدون دسته بندی'); ?></td>
                ...
                <div class="paginate p-3">
                    ...
                    <?php if(!auth()->user()->hasRole('watcher')): ?>
                    <a href="<?php echo e(route('article-create',$type)); ?>" class="btn btn-rounded btn-primary float-left"><i class="fa fa-circle-o ml-1"></i>افزودن</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
