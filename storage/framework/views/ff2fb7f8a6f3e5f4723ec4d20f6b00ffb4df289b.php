                                ...
                                <td width="140">
                                    ...
                                    <div class="btn-inline">
                                        ...
                                        <?php endswitch; ?>
                                            ...
                                            <a href="<?php echo e(route('location-pupular',$location->id)); ?>" title="شهر محبوب"><span class="badge badge-success"><?php echo $location->pupular == true ? '<i class="fa fa-check"></i>' : 'انتخاب نشده'; ?> </span></a>
