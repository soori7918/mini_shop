<?php $__env->startComponent('layouts.back'); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group <?php if($errors->has('name')): ?> has-danger <?php endif; ?>">
                            <?php echo e(Form::label('name', 'نام ویلا')); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            <?php echo e(Form::label('location_id', 'مقصد ویلا')); ?>
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group district">
                            <?php echo e(Form::label('district', 'محل ویلا')); ?>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group <?php if($errors->has('space')): ?> has-danger <?php endif; ?>">
                            <?php echo e(Form::label('space', 'فضای ویلا')); ?>

                            <?php echo e(Form::text('space', '', array('placeholder' => 'فضای ویلا', 'class' => 'form-control'))); ?>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            <?php echo e(Form::label('villa_place', 'موقعیت ویلا')); ?>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            <?php echo e(Form::label('nearest', 'ویلاهای نزدیک', array('style' => 'font-size: 10px'))); ?>
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            <?php echo e(Form::label('villaNow', 'ویلاهای مشابه', array('style' => 'font-size: 10px'))); ?>
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group bootstrap-selects <?php if($errors->has('price')): ?> has-danger <?php endif; ?>">
                            ...
                            <?php echo e(Form::select('price_type', array('dollar' => ' دلار','rial' => 'ریال', 'euro' => 'یورو'), '', array('class' => 'form-control selectpicker', 'style' => 'width:26%;margin-right:.2rem;float:right'))); ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <?php echo e(Form::textarea('body', 'توضیحات ویلا', array('id' => 'body', 'class' => 'form-control textarea'))); ?>

                        </div>
                        <div class="form-group">
                            <?php echo e(Form::textarea('services', 'خدمات و سرویس های ویلا', array('id' => 'services', 'class' => 'form-control textarea'))); ?>

                        </div>
                        <div class="form-group">
                            <?php echo e(Form::textarea('information', 'اطلاعات مفید ویلا', array('id' => 'information', 'class' => 'form-control textarea'))); ?>
                        ...
                        <div>
                            <input  id="geocomplete" type="text" placeholder="نام ویلا یا آدرس ویلا" size="90" />
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script src="<?php echo e(asset('js/geo.min.js')); ?>"></script>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $.getJSON(base_url + "/panel/districts/" + id, function (data) {
                    ...
                    district.empty();
                    district.append('<label for="district">محل ویلا</label> <select class="form-control selectpicker" id="district" name="district"></select>');
