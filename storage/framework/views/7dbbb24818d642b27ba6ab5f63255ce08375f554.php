        ...
        <div class="simplebar-scroll-content" style="padding-right: 17px; margin-bottom: -34px;">
            <div class="simplebar-content" style="padding-bottom: 17px; margin-right: -17px;">
                ...
                <div class="brand-logo" style="cursor: pointer">
                    <img onclick="window.open('<?php echo e(route('user.index')); ?>','_blank')" src="<?php echo e(url('assets/user/pic/logo.png')); ?>" class="logo-icon full" style="width: 100%;height: 100px; object-fit: contain" alt="logo icon">
                    <img onclick="window.open('<?php echo e(route('user.index')); ?>','_blank')" src="<?php echo e(url('assets/user/pic/logo.png')); ?>" class="logo-icon mini" style="width: 100%;height: auto" alt="logo icon">
                ...
                <ul class="metismenu mm-show" id="menu">
                    ...
                    <li class="" >
                        ...
                        <ul class="mm-collapse" style="height: 2px;">
                            <li><a href="<?php echo e(route('slider-list')); ?>"><i class="zmdi zmdi-dot-circle-alt"></i>
                                    اسلایدر</a></li>
                            <li><a href="<?php echo e(route('menu-list')); ?>"><i class="zmdi zmdi-dot-circle-alt"></i>
                                    منو</a></li>
                    ...
                    <li class="">
                        ...
                        <ul class="mm-collapse" style="height: 2px;">
                            <li><a href="<?php echo e(route('project-category-list')); ?>"><i class="zmdi zmdi-dot-circle-alt"></i>
                            ...
                            <li><a href="<?php echo e(route('agent.index')); ?>"><i class="zmdi zmdi-dot-circle-alt"></i> لیست نمایندگان</a>
                            </li>
                    ...
                    <li class="">
                        ...
                        <li class="">
                            ...
                            <ul class="mm-collapse" style="height: 2px;">
                                ...
                                <li><a href="<?php echo e(route('settings.index')); ?>"><i class="zmdi zmdi-dot-circle-alt"></i>تنظیمات سایت </a></li>
