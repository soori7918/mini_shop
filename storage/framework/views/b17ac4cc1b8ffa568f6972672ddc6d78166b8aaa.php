                    ...
                    <?php if(count($projects)): ?>
                        <table id="dataTable" class="archive-table">
                            ...
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <img src="<?php echo e($project->image!=null?url($project->image):''); ?>" width="55" alt="">
                                    </td>
                                    <td>
                                        <?php echo e($project->title); ?>

                                        ( <?php echo e($project->user?$project->user['first_name'].' '.$project->user['last_name']:'مریم کیامرام'); ?>
                                    ...
                                    <td>
                                        <?php switch($project->status):
                                            ...
                                            <a href="<?php echo e(route('villa-category-active',[$project->id,'published'])); ?>"><span class="badge badge-success"><i class="fa fa-check"></i> </span></a>
                                            <?php break; ?>
                                            <?php case ('published'): ?>
                                            <span class="badge badge-success">نمایش</span>
                                            <a href="<?php echo e(route('villa-category-active',[$project->id,'pending'])); ?>"><span class="badge badge-danger"><i class="fa fa-close"></i> </span></a>
                                            <?php break; ?>
                                            <?php default: ?>
                                        <?php endswitch; ?>
                                    </td>
                                    <td>
                                        <?php echo e($project->count_all_unit); ?>

                                    </td>
                                    <td>
                                        <?php echo Form::open(['method' => 'POST', 'route' => ['villa-category-update-count', $project->id],'id'=>'form_count_'.$key ]); ?>

                                        فروش رفته

                                        <input type="number" name="count" value="<?php echo e($project->count_sale_unit); ?>" class="counter" data-id="<?php echo e($key); ?>">
                                        <?php echo Form::close(); ?>
                                    ...
                                    <td width="160">
                                        <?php if(!auth()->user()->hasRole('watcher')): ?>
                                            <div class="btn-inline pt-0">
                                                <a href="<?php echo e(route('meterage.index', $project->id)); ?>"
                                                   class="btn btn-warning float-left mx-1 mb-0"><i
                                                            class="fa fa-edit ml-1"></i>لیست متراژ</a>
                                                <a href="<?php echo e(route('villa-category-edit', $project->id)); ?>"
                                                   class="btn btn-warning float-left mx-1 mb-0"><i
                                                            class="fa fa-edit ml-1"></i>ویرایش</a>
                                                <?php echo Form::open(['method' => 'DELETE', 'route' => ['villa-category-destroy', $project->id] ]); ?>
