...
<?php $__env->startSection('body'); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title-area ltn__section-title-2--- text-center">
                            ...
                            <h1 class="section-title">خدمات وندیداد گروپ</h1>
                        </div>
                    </div>
                </div>
    ...
    <div class="ltn__video-popup-area ltn__video-popup-margin---">
        <div class="ltn__video-bg-img ltn__video-popup-height-600--- bg-overlay-black-30 bg-image bg-fixed ltn__animation-pulse1" data-bg="<?php echo e(url($video->pic)); ?>">
    ...
    <?php if(count($villasAsItems)): ?>
        ...
        <div class="ltn__search-by-place-area section-bg-1 before-bg-top--- bg-image-top--- pt-115 pb-70" data-bg="<?php echo e(url('source/assets/user/rtl/img/bg/20.jpg')); ?>">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title-area ltn__section-title-2--- text-center">
    ...
    <?php if($about1): ?>
        <!-- Abouts1 AREA START -->
        <div class="ltn__video-popup-area ltn__video-popup-margin---">
            <div class="ltn__video-bg-img ltn__video-popup-height-600--- bg-overlay-black-30 bg-image bg-fixed ltn__animation-pulse1" data-bg="<?php echo e($about1->pic?url($about1->pic):url('source/assets/user/pic/back.jpg')); ?>">
        ...
        <div class="ltn__testimonial-area ltn__testimonial-4 pt-115 pb-100 plr--9">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title-area ltn__section-title-2--- text-center">
                            <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">برترین و پربازدیدترین مناطق ازمیر</h6>
                            <h1 class="section-title">مناطق ازمیر</h1>
                        </div>
                    </div>
                </div>
                <div class="row">
                                            ...
                                            <div class="ltn__img-slide-item-4">
                                                <?php if(count($selectedLocation->photos)): ?>
                                                    <?php $__currentLoopData = $selectedLocation->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <a href="<?php echo e($photo->path?url($photo->path):url('source/assets/user/rtl/img/testimonial/1.jpg')); ?>" data-rel="lightcase:myCollection<?php echo e($selectedLocation->id); ?>">
                                                            <img <?php echo e($key>0?'hidden':''); ?> src="<?php echo e($photo->path?url($photo->path):url('source/assets/user/rtl/img/testimonial/1.jpg')); ?>" alt="<?php echo e($selectedLocation->name); ?>">
                                                        </a>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
        ...
        <div class="ltn__blog-area pt-120 pb-70">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title-area ltn__section-title-2--- text-center">
                            <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">آخرین ها</h6>
                            <h1 class="section-title">رادیو وندیداد</h1>
                        </div>
                    </div>
                </div>
                <div class="row  ltn__blog-slider-one-1-active slick-arrow-1 ltn__blog-item-3-normal">
                <?php $__currentLoopData = $radios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $radio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!-- Blog Item -->
                        <div class="col-lg-12 px-1">
                            <?php echo $__env->make('user.includes.blogCard',['blog'=>$radio], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <!--  -->
                </div>
