<?php $__env->startComponent('layouts.front'); ?>
    ...
    <?php $__env->slot('meta'); ?>
        <?php if($villa->meta_keywords): ?>
            <meta http-equiv="keywords" name="keywords" content="<?php echo e($villa->meta_keywords); ?>"/>
        <?php endif; ?>
        <?php if($villa->meta_description): ?>
            <meta http-equiv="description" name="description" content="<?php echo e($villa->meta_description); ?>"/>
        <?php endif; ?>

        <meta property="og:title" content="<?php echo e($villa->title); ?>"/>
        <meta property="og:type" content="Villa"/>
        <meta property="og:url" content="<?php echo e(route('front-villa-show',$villa->slug)); ?>"/>
        <meta property="og:image" content="<?php echo e(url($villa->photo->path)); ?>"/>
        <meta property="og:site_name" content="<?php echo e($setting->title); ?>"/>
        <meta property="og:locale" content="fa_ir"/>
        <?php if($villa->meta_description): ?>
            <meta property="og:description" content="<?php echo e($villa->meta_description); ?>"/>
        <?php endif; ?>
    <?php $__env->endSlot(); ?>
    <?php $__env->slot('body'); ?>
        <style>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <aside class="post-sidebars">
                            ...
                            <!-- Begin Taghvim -->
                            <div class="post-sidebar mb-4" id="taghvimcontainer">
                                <div id="taghvim" style="overflow: hidden;">
                                </div>
                            </div>
                            <!-- End Taghvim -->
                            <div class="post-sidebar text-justify mb-4 mobile-post-villa-right">
                                ...
                                <p>&#1605;&#1607;&#1740;&#1575; &#1705;&#1585;&#1583;&#1606; &#1576;&#1607;&#1578;&#1585;&#1740;&#1606;
                                    ...
                                    &#1570;&#1588;&#1606;&#1575; &#1588;&#1608;&#1740;&#1583;. <a href="#">&#1711;&#1588;&#1578;
                                        &#1607;&#1575;&#1740;
                                        &#1578;&#1601;&#1585;&#1740;&#1581;&#1740; <?php echo e($villa->location->name); ?></a></p>
