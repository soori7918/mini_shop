                ...
                <div class="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" hidden>
                            <div class="form-group">
                                <?php echo e(Form::label('type', 'نمایش')); ?>

                                <select name="type" class="form-control">
                                    <option value="1" <?php if($slider->type == 1): ?> selected <?php endif; ?>>موبایل</option>
                                    <option value="2" <?php if($slider->type == 2): ?> selected <?php endif; ?>>دکستاپ</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" style="margin-top: 10px;">
                            <div class="form-group">
                                <?php echo e(Form::label('photo', 'تصویر فعال')); ?>

                               <img src="<?php echo e($slider->photo?url($slider->photo->path):''); ?>" height="150px">
                            </div>
                        </div>
                    </div>
                    <br/>
