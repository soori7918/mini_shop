...
<head>
    ...
    <meta property="og:image" content="<?php echo e(asset('source/assets/user/pic/logo.png')); ?>" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Place favicon.png in the root directory -->
    <link rel="shortcut icon" href="<?php echo e(url('source/assets/user/pic/logo.png')); ?>" type="image/x-icon" />
    <!-- Font Icons css -->
    <link rel="stylesheet" href="<?php echo e(url('source/assets/user/rtl/css/font-icons.css')); ?>">
    <!-- plugins css -->
    <link rel="stylesheet" href="<?php echo e(url('source/assets/user/rtl/css/plugins.css')); ?>">
    <!-- Chosen css -->
    <link rel="stylesheet" href="<?php echo e(url('source/assets/user/chosen/css.css')); ?>">
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="<?php echo e(url('source/assets/user/rtl/css/style.css')); ?>">
    <!-- Responsive css -->
    <link rel="stylesheet" href="<?php echo e(url('source/assets/user/rtl/css/responsive.css')); ?>">
...
<?php endif; ?>
   ...
   <?php echo $__env->yieldContent('body'); ?>
    ...
    <div class="ltn__call-to-action-area call-to-action-6 before-bg-bottom" data-bg="<?php echo e(url('source/assets/user/rtl/img/1.jpg')); ?>">
           <div class="container">
               <div class="row">
                   <div class="col-lg-12">
    ...
    <!-- icall AREA START -->
        <div class="icall icall1">
            <a target="_blank" rel="noreferrer" href="tel:+<?php echo e(str_replace([' ','_','-'],'',$contact_provider->phone_icall)); ?>">
                <img class="social_img" src="<?php echo e(url('source/assets/user/pic/icall_1.png')); ?>" alt="آیکال وندیداد">
            </a>
        </div>
        <!-- icall AREA END -->
 <?php endif; ?>
        ...
        <!-- WHATSAPP AREA START -->
            <div class="wat_sapp wat_sapp1">
                <a target="_blank" rel="noreferrer" href="https://api.whatsapp.com/send?phone=+<?php echo e(str_replace([' ','_','-'],'',$contact_provider->phone_whatsapp)); ?>">
                    <img class="social_img" src="<?php echo e(url('source/assets/user/pic/whatssapp_1.png')); ?>" alt="واتساپ وندیداد">
                </a>
            </div>
            <!-- WHATSAPP AREA END -->
    <?php endif; ?>
...
<!-- All JS Plugins -->
<script src="<?php echo e(url('source/assets/user/rtl/js/plugins.js')); ?>"></script>
<!-- Chosen -->
<script src="<?php echo e(url('source/assets/user/chosen/js.js')); ?>"></script>
<!-- Main JS -->
<script src="<?php echo e(url('source/assets/user/rtl/js/main.js')); ?>"></script>
