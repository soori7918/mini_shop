    ...
    <?php $__env->slot('body'); ?>
        <div class="card" dir="rtl">
            <div class="card-header archive-card-header">
                ...
                <div class="card-body">
                    <?php echo e(Form::open(array('route' => 'agent.store', 'method' => 'POST', 'files' => true, 'style' => 'width:100%!important;min-width:100%!important'))); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('address', '', array('class' => 'form-control'))); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <?php echo e(Form::textarea('description', '', array('id' => 'body', 'class' => 'form-control textarea'))); ?>
