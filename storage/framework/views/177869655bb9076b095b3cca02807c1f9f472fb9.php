                    ...
                    <table id="dataTable" class="archive-table table">
                        ...
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <?php if(!is_null($item->user->type_request)): ?>
                                        <?php
                                        ...
                                        <?php else: ?>
                                            <?php if(gettype(unserialize($item->user->type_request))=='array'): ?>
                                                <?php $__currentLoopData = unserialize($item->user->type_request); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td><?php echo e($item->price); ?> <?php echo e($item->price_type); ?></td>
