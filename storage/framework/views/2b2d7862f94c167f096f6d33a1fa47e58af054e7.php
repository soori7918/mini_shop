            ...
            <div class="card-header archive-card-header">
                <div class="archive-circle-wrap">
                    <?php if(isset($profile->photo)): ?>
                        <div style="background-image: url(<?php echo e(url($profile->photo->path)); ?>);background-size: cover;background-repeat: no-repeat " class="archive-circle">
                        </div>
                    <?php else: ?>
                ...
                <div class="max-with">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong>موبایل
                                : </strong><?php echo e($profile->mobile); ?> <?php if($profile->mobile_status == 'active'): ?><span
                        ...
                        <li class="list-group-item"><strong>وضعیت کلی
                                ...
                                <span class="badge badge-warning">در انتظار تایید</span><?php elseif($profile->account_status == 'blocked'): ?>
