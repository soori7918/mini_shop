...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('editor/laravel-filemanager/img/folder.png')); ?>">
  <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css">
  <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="<?php echo e(asset('editor/laravel-filemanager/css/cropper.min.css')); ?>">
  
  
   <link rel="stylesheet" href="<?php echo e(asset('editor/laravel-filemanager/css/lfm.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('editor/laravel-filemanager/css/mfb.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('editor/laravel-filemanager/css/dropzone.min.css')); ?>">
...
<body>
  ...
  <div id="lfm-loader">
    <img src="<?php echo e(asset('editor/laravel-filemanager/img/loader.svg')); ?>">
  </div>
  ...
  <script src="<?php echo e(asset('editor/laravel-filemanager/js/cropper.min.js')); ?>"></script>
  <script src="<?php echo e(asset('editor/laravel-filemanager/js/jquery.form.min.js')); ?>"></script>
  <script src="<?php echo e(asset('editor/laravel-filemanager/js/dropzone.min.js')); ?>"></script>
  <script>
   ...
   <script src="<?php echo e(asset('editor/laravel-filemanager/js/script.js')); ?>"></script>
  <script>
    $.fn.fab = function () {
      var menu = this;
