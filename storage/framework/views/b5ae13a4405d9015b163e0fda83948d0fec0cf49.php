        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::select('status', array('no' => 'خیر', 'yes' => 'بله'), '', array('class' => 'form-control selectpicker'))); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('type', 'مکان ویژگی')); ?>

                    <?php echo e(Form::select('type', array('0' => 'داخل', '1' => 'خارج'), '', array('class' => 'form-control selectpicker'))); ?>
