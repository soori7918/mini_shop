        ...
        <div class="uk-width-1-4@m uk-align-center cont_box_1">
            <div class="cont_box">
                ...
                <div class="control_box">
                    ...
                    <input name="username" type="text" class="text-left" style="direction: rtl" placeholder="بدونه صفر(9121111111)">
                </div>
                <div class="control_box">
                ...
                <div class="log_des_box">
                    <p>کارشناس جدید هستید؟<a href="<?php echo e(route('front.register.office')); ?>"> ثبت نام </a> در خانه استانبول</p>
