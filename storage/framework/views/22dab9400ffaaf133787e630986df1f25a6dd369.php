<?php $__env->startComponent('layouts.back'); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('properties_out[]', array_pluck($propertiesout, 'name', 'id'), json_decode($category->properties_out), array('class' => 'form-control selectpicker', 'multiple'))); ?>
                        ...
                        <div class="col-md-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('properties_access[]', array_pluck($propertiesaccess, 'name', 'id'), json_decode($category->properties_access), array('class' => 'form-control selectpicker', 'multiple'))); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select select_js state_id " name="state_id" id="state_id" data-type="state_id" data-reply="city_id" data-name="شهر">
                                    ...
                                    <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option data-target=".cityId<?php echo e($city->id); ?>" value="<?php echo e($city->id); ?>"<?php echo e(old('state_id') == $city->id ? 'selected' : ''); ?><?php echo e($category->state_id == $city->id ? 'selected' : ''); ?>><?php echo e($city->name); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select select_js city_id" name="city_id" id="city_id" data-type="city_id" data-reply="zone_id" data-name="منطقه">
                                    ...
                                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option data-target=".cityId<?php echo e($city->id); ?>" value="<?php echo e($city->id); ?>"<?php echo e(old('city_id') == $city->id ? 'selected' : ''); ?><?php echo e($category->city_id == $city->id ? 'selected' : ''); ?>><?php echo e($city->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select  zone_id" name="zone_id" id="zone_id">
                                    ...
                                    <?php $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option data-target=".cityId<?php echo e($city->id); ?>" value="<?php echo e($city->id); ?>"<?php echo e(old('zone_id') == $city->id ? 'selected' : ''); ?><?php echo e($category->zone_id == $city->id ? 'selected' : ''); ?>><?php echo e($city->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-center" name="count_all_unit" id="count_all_unit "
                                       value="<?php echo e(old('count_all_unit', $category->count_all_unit)); ?>">
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control text-center" name="count_sale_unit" id="count_sale_unit"
                                       value="<?php echo e(old('count_sale_unit', $category->count_sale_unit)); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <style>
                                ...
                                <div class="col-md-2">
                                    <?php if($category->pic): ?>
                                    <a href="<?php echo e(url($category->pic)); ?>" target="_blank" class="">
                                        <img class="img-fluid" src="<?php echo e(url($category->pic)); ?>" alt="">
                                    </a>
                                        <?php endif; ?>
                                </div>
                        </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script async defer
                src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDXe6p8wfFL2UygcASee788uNwjAks5zNg&libraries=places&callback=initialize"></script>
        ...
        <script type="text/javascript">
            ...
            var lat = <?php echo e(old('latitude', $category->latitude??'41.006979471344955')); ?>;
            var lng = <?php echo e(old('longitude', $category->longitude??'28.98226461381144')); ?>;
