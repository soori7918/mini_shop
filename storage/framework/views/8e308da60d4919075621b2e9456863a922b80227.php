<?php $__env->startComponent('layouts.back'); ?>
    ...
    <?php $__env->slot('body'); ?>
        <div class="card">
            ...
            <div class="card-body">
                <div class="post">
                    <?php echo e(Form::open(array('route' => 'slider-update', 'method' => 'patch', 'files' => true))); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('title', $slider->title , array('class' => 'form-control'))); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('shoar', $slider->shoar, array('class' => 'form-control'))); ?>

                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php echo e(Form::textarea('text', $slider->text, array('class' => 'form-control textarea', 'required'))); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="page" class="form-control">
                                    <option value="1" <?php if($slider->page == 1): ?> selected <?php endif; ?>>مقاصد سفر</option>
                                    <option value="2" <?php if($slider->page == 2): ?> selected <?php endif; ?>>مجله</option>
                                    <option value="3" <?php if($slider->page == 3): ?> selected <?php endif; ?>>درباره ما</option>
                                    <option value="4" <?php if($slider->page == 4): ?> selected <?php endif; ?>>ارتباط با ما</option>
                                    <option value="5" <?php if($slider->page == 5): ?> selected <?php endif; ?>>ثبت نام</option>
                                    <option value="6" <?php if($slider->page == 6): ?> selected <?php endif; ?>>علاقه مندی ها</option>
                                    <option value="7" <?php if($slider->page == 7): ?> selected <?php endif; ?>>صفحات داخلی مجله</option>
                                </select>
                            </div>
                        </div>
