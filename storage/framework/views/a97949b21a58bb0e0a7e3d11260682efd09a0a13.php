...
<?php $__env->slot('body'); ?>
    <div class="uk-width-1-4@m uk-align-center cont_box_1">
        <div class="cont_box">
            ...
            <?php echo e(Form::open(array('route' => 'register', 'method' => 'post', 'files' => true))); ?>
            ...
            <div class="control_box" style="position: relative">
                ...
                <input id="mobile" name="mobile" type="text" class="text-left mobile"
                       style="direction:ltr;padding-left: 85px" placeholder="(---) --- ----" value="<?php echo e(old('mobile')); ?>">
            ...
            <div class="control_box">
                ...
                <input id="password" name="password" type="password" class="text-left"
                       style="direction: ltr"
                       placeholder="رمز عبور خود را وارد کنید" value="<?php echo e(old('password')); ?>">
            </div>
            <div class="control_box">
            ...
            <div class="control_box">
                ...
                <input id="job" name="job" type="text" placeholder="شغل" value="<?php echo e(old('job')); ?>">
            </div>
            ...
            <div class="log_des_box">
                <p>قبلا در خانه استانبول ثبت نام کرده اید ؟<a href="<?php echo e(url('login')); ?>">وارد شوید</a></p>
            </div>
