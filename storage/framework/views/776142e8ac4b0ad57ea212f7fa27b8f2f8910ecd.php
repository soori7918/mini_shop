...
<head>
    ...
    <!--favicon-->
    <link rel="icon"
          href="<?php echo e(asset('user/pic/logo.png')); ?>"
          type="image/x-icon">
    <!-- Vector CSS -->
    ...
    <!-- Metismenu CSS-->
    <link href="<?php echo e(asset('dashboard/metisMenu.css?v=').time()); ?>" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('dashboard/jquery-ui.css')); ?>">
    <!-- Chosen css -->
    <link rel="stylesheet" href="<?php echo e(asset('user/chosen/css.css')); ?>">
    <!-- Custom Style-->
    <link href="<?php echo e(asset('dashboard/app-style.css?v=').time()); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/fonts.min.css')); ?>" rel="stylesheet">
        ...
        <div class="simplebar-scroll-content" style="padding-right: 17px; margin-bottom: -34px;">
            <div class="simplebar-content" style="padding-bottom: 17px; margin-right: -17px;">
                ...
                <div class="brand-logo" style="cursor: pointer">
                    <img onclick="window.open('<?php echo e(route('user.index')); ?>','_blank')" src="<?php echo e(asset('user/pic/logo.png')); ?>" class="logo-icon h-100 full" alt="logo icon">
                    <img onclick="window.open('<?php echo e(route('user.index')); ?>','_blank')" src="<?php echo e(asset('user/pic/logo.png')); ?>" class="logo-icon h-100 mini" alt="logo icon">
                    ...
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" data-toggle="dropdown"
                       href="javascript:void(0);">
                        <span class="user-profile">
                            <img src="<?php echo e(auth()->user()->photo ? url(auth()->user()->photo->path) : asset('dashboard/avatar-13.png')); ?>"
                                 class="img-circle"
                                 alt="user avatar">
                        </span>
                    </a>
                            ...
                            <a href="<?php echo e(route('profile-show', Auth::user()->id)); ?>">
                                <div class="media">
                                    <div class="avatar"><img class="align-self-start mr-3"
                                                             src="<?php echo e(auth()->user()->photo ? url(auth()->user()->photo->path) : asset('dashboard/avatar-13.png')); ?>"
                                                             alt="user avatar"></div>
                                    <div class="media-body">
...
<script src="<?php echo e(asset('dashboard/jquery-ui.js')); ?>"></script>




<!-- Custom scripts -->
<script src="<?php echo e(asset('dashboard/app-script.js?v=').time()); ?>"></script>
<!-- Chart js -->
...
<!-- Chosen -->
<script src="<?php echo e(asset('user/chosen/js.js')); ?>"></script>
