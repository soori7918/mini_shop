...
<?php $__env->startSection('styles'); ?>
    <style>
        ...
        .hovereffect a.info, .hovereffect h2,.hovereffect p.p_class {
        ...
        .hovereffect:hover a.info, .hovereffect:hover h2 ,.hovereffect:hover p.p_class{
            opacity: 1;
                    ...
                    <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="hovereffect">
                                <img class="img-responsive" src="<?php echo e($blog->photo!=null?url($blog->photo):''); ?>" alt="<?php echo e($blog->title); ?>">
                                <div class="overlay">
