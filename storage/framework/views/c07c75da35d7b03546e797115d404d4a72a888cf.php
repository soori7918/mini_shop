    ...
    <?php $__env->slot('body'); ?>
        <div class="card">
            <div class="card-header archive-card-header">
                ...
                <div class="card-body">
                    <?php echo e(Form::open(array('route' => 'project-category-save', 'method' => 'POST', 'files' => true, 'style' => 'width:100%!important;min-width:100%!important'))); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('url', '', array('class' => 'form-control'))); ?>
                        ...
                        <div class="col-6  d-none icon">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('icon', '', array('class' => 'form-control'))); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('title_seo', '', array('class' => 'form-control'))); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('url_seo', '', array('class' => 'form-control'))); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('h1_seo', '', array('class' => 'form-control'))); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('keyword_seo', '', array('class' => 'form-control'))); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('schima', '', array('class' => 'form-control'))); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::textarea('description_seo', '', array('class' => 'form-control','rows'=>3))); ?>
