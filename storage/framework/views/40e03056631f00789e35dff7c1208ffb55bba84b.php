<?php $__env->startComponent('layouts.back'); ?>
    <?php $__env->slot('title'); ?> بررسی <?php echo e($title); ?> <?php echo e($villa->name); ?> <?php $__env->endSlot(); ?>
    <?php $__env->slot('body'); ?>
        <style>
            .price_input {
                padding-right: 35px;
        ...
        <div class="card">
            <div class="card-header archive-card-header">
                <div class="archive-circle-wrap">
                    ...
                    <h2>بررسی <?php echo e($title); ?> <?php echo e($villa->name); ?>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group <?php if($errors->has('slug')): ?> has-danger <?php endif; ?>">
                            ...
                            <?php echo e(Form::number('built_year', null, array('class' => 'form-control'))); ?>
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group <?php if($errors->has('floor')): ?> has-danger <?php endif; ?>">
                            ...
                            <?php echo e(Form::number('floor', null, array('placeholder' => 'طبقه چندم', 'class' => 'form-control'))); ?>
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group bootstrap-selects <?php if($errors->has('price')): ?> has-danger <?php endif; ?>">
                            ...
                            <?php echo e(Form::text('price', null, array('class' => 'form-control text-center price_input price_mask'))); ?>
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            <?php echo e(Form::label('tip_info', 'نوع خدمات ملک')); ?>

                            <?php echo e(Form::select('tip_info', ['1'=>'مناسب برای اخذ شهروندی و پاسپورت ترکیه','2'=>'مناسب برای اخذ اقامت ترکیه'], null, array('class' => 'form-control selectpicker'))); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?php echo e(route('villa-status', ['villa'=> $villa])); ?>" method="POST"
                            ...
                            <div class="form-group mt-1 status-message">
                                ...
                                <textarea class="form-control" id="status_message" name="status_message"
                                          ...
                                          placeholder="علت رد ..."><?php echo $villa->status_message; ?></textarea>
                            </div>
                        </form>
