<?php $__env->startComponent('layouts.back'); ?>
    <?php $__env->slot('title'); ?> ویرایش <?php echo e($title); ?> <?php echo e($location->name); ?> <?php $__env->endSlot(); ?>
    <?php $__env->slot('body'); ?>
        <div class="card">
            <div class="card-header archive-card-header">
                <div class="archive-circle-wrap">
                    ...
                    <h2>ویرایش <?php echo e($title); ?> <?php echo e($location->name); ?></h2>
                </div>
            </div>
            <div class="card-body">
                <?php echo e(Form::model($location, array('route' => array('location-update', $location->id), 'method' => 'PATCH', 'files' => true))); ?>

                <?php echo e(Form::hidden('latitude', null, array('id' => 'latitude'))); ?>

                <?php echo e(Form::hidden('longitude', null, array('id' => 'longitude'))); ?>

                <div class="form-group">
                    <?php echo e(Form::textarea('body', null, array('id' => 'body', 'class' => 'form-control textarea', 'rows' => 5))); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('status', 'پرطرفدار')); ?>

                    <?php echo e(Form::select('status', array('manual' => 'نیست', 'best' => 'هست'), null, array('class' => 'form-control selectpicker'))); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('name', 'نام مقصد')); ?>

                    <?php echo e(Form::text('name', null, array('placeholder' => 'تهران, ایران', 'class' => 'form-control'))); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('url', 'url')); ?>

                    <?php echo e(Form::text('url', null, array('placeholder' => 'phuket', 'class' => 'form-control'))); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('districts', $district, array('placeholder' => 'محل 1، محل 2', 'id' => 'districts', 'class' => 'form-control districts'))); ?>

                </div>
                <div class="form-group">
                    <?php echo e(Form::label('slogan', 'شعار')); ?>

                    <?php echo e(Form::text('slogan', null, array('class' => 'form-control'))); ?>

                </div>
                <div class="float-right w-100 my-5">
                    <div class="add-more">
                        <a href="javascript:void(0)" class="btn btn-secondary click-to-add-description"><i class="fa fa-plus ml-2"></i><span>افزودن توضیحات بیشتر</span></a>
                        <hr/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('title', null, array('class' => 'form-control' , 'placeholder' => 'عنوان صفحه'))); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script type="text/javascript">
            ...
            var lat = "<?php echo e(number_format((float)$location->latitude, 5, '.', '')); ?>";
            var lng = "<?php echo e(number_format((float)$location->longitude, 5, '.', '')); ?>";
