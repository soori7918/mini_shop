        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('name', '', array('placeholder' => 'تهران, ایران', 'class' => 'form-control','placeholder'=>'esenyurt'))); ?>
                ...
                <div class="form-group">
                    <?php echo e(Form::textarea('body', '', array('id' => 'body', 'class' => 'form-control textarea','placeholder'=>'توضیحات تکمیلی', 'rows' => 5))); ?>
