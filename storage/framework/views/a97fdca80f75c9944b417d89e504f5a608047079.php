        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        <div class="ltn__contact-address-icon">
                            <img src="<?php echo e(url('assets/user/pic/icons/email.png')); ?>" alt="Icon Image">
                        </div>
                        <h3>آدرس ایمیل</h3>
                        <p>
                            <?php if($item->email): ?>
                ...
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        <div class="ltn__contact-address-icon">
                            <img src="<?php echo e(url('assets/user/pic/icons/phone.png')); ?>" alt="Icon Image">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        <div class="ltn__contact-address-icon">
                            <img src="<?php echo e(url('assets/user/pic/icons/map.png')); ?>" alt="Icon Image">
                        </div>
                        <h3>آدرس دفتر</h3>
