<?php $__env->startComponent('layouts.back'); ?>
    ...
    <?php $__env->slot('body'); ?>
        <div class="row">
            <div class="col-md-12 mb-2">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <span class="share-to" >
                        <input class="form-control text-center" type="text" id="share_link" value="<?php echo e(route('front.register.office', ['ref' => auth()->user()->code])); ?>">
                        </span>
                        <br>
                        <a href="javascript:void(0)" onclick="copyToClipboard()" class="btn btn-light mt-3">کپی کردن</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-content">
                        <div class="row row-group m-0">
                            <div class="col-12 border-light">
                                <div class="card-body">
                                    <h5 class="text-white mb-0"><?php echo e($users_count); ?>

                                        <span style="font-size: 12px">(مشتری)</span>
                                        <span class="float-right"><i class="fa fa-user"></i></span></h5>
                                    <a href="<?php echo e(route('user-list')); ?>?type=myCustomers" class="mb-0 text-white small-font">لیست همه
                                        مشتریان</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 border-light">
                                <div class="card-body">
                                    <h5 class="text-white mb-0">
                                        ...
                                        <span style="font-size: 12px">(ملک)</span>
                                        <?php echo e($published_count); ?>

                                        <span style="font-size: 12px">(تایید شده)</span>
                                        <?php echo e($pending_count); ?>

                                        <span style="font-size: 12px">(در انتظار تایید)</span>
                                        <span class="float-right"><i class="fa fa-home"></i></span></h5>
                                    <?php if(auth()->user()->hasRole('مدیر') || auth()->user()->hasRole('مدیر ملک') || auth()->user()->hasRole('call center') || auth()->user()->hasRole('call center(sales)')): ?>
                                    <a href="<?php echo e(route('villa-list','published')); ?>" class="mb-0 text-white small-font">لیست همه
                                        ملکها</a>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <div class="col-md-4">
                <div class="card mt-3 ">
                    <div class="card-content">
                        <div class="row row-group m-0">
                            <div class="col-12 border-light <?php echo e($refers_count>0?'bg-danger':''); ?>">
                                <div class="card-body">
                                    <h5 class="text-white mb-0"><?php echo e($refers_count); ?>

                                        <span style="font-size: 12px">(ارجاع)</span>
                                        <span class="float-right"><i class="fa fa-share-square"></i></span></h5>
                                    <?php if(auth()->user()->hasRole('مدیر') || auth()->user()->hasRole('مدیر ملک') || auth()->user()->hasRole('call center') || auth()->user()->hasRole('call center(sales)')): ?>
                                    <a href="<?php echo e(route('user-refer-list')); ?>" class="mb-0 text-white small-font">لیست همه
                                        ارجاعات</a>
                                    <?php endif; ?>
                                </div>
                            </div>
        ...
        <div class="card mt-3 <?php echo e(auth()->user()->account_status!='active'?'':'d-none'); ?>">
            <div class="card-content">
                <div class="row row-group m-0">
                    <div class="col-md-12 border-light">
                        <div class="card-body p-5">
                            <div class="alert alert-danger px-4 py-3 text-center" role="alert">
                                <h5 class="text-white text-center">
                                    <?php echo auth()->user()->status_message; ?>

                                </h5>

                                <?php
                                    $editables=[];
                                    if (!is_null(auth()->user()->editables)){
                                        if (is_serialized(auth()->user()->editables)){
                                            $editables=unserialize(auth()->user()->editables);
                                        }
                                    }
                                ...
                                <div class="form-group mt-3">
                                    <div class="col-md-12">
                                        <strong>بخش هایی که باید اصلاح شوند : </strong>
                                    </div>
                                    <?php if(in_array('fname_en',$editables)): ?>
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" <?php echo e(in_array('fname_en',$editables)?'checked':''); ?>>نام (انگلیسی)
                                        </label>
                                    </div>
                                    <?php endif; ?>
                                    <?php if(in_array('lname_en',$editables)): ?>
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" <?php echo e(in_array('lname_en',$editables)?'checked':''); ?>>نام خانوادگی (انگلیسی)
                                        </label>
                                    </div>
                                    <?php endif; ?>
                                    <?php if(in_array('father_name',$editables)): ?>
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" <?php echo e(in_array('father_name',$editables)?'checked':''); ?>>نام پدر
                                        </label>
                                    </div>
                                    <?php endif; ?>
                                    <?php if(in_array('gender',$editables)): ?>
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" <?php echo e(in_array('gender',$editables)?'checked':''); ?>>جنسیت
                                        </label>
                                    </div>
                                    <?php endif; ?>
                                    <?php if(in_array('living_country',$editables)): ?>
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" <?php echo e(in_array('living_country',$editables)?'checked':''); ?>>کشور در حال زندگی
                                        </label>
                                    </div>
                                    <?php endif; ?>
                                    <?php if(in_array('nationality',$editables)): ?>
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" <?php echo e(in_array('nationality',$editables)?'checked':''); ?>>ملیت
                                        </label>
                                    </div>
                                    <?php endif; ?>
                                    <?php if(in_array('Job',$editables)): ?>
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" <?php echo e(in_array('Job',$editables)?'checked':''); ?>>شغل
                                        </label>
                                    </div>
                                    <?php endif; ?>
                                    <?php if(in_array('ncode',$editables)): ?>
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" <?php echo e(in_array('ncode',$editables)?'checked':''); ?>>کدملی/شماره پاسپورت
                                        </label>
                                    </div>
                                    <?php endif; ?>
                                    <?php if(in_array('postal_address',$editables)): ?>
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="s" <?php echo e(in_array('postal_address',$editables)?'checked':''); ?>>آدرس
                                        </label>
                                    </div>
                                    <?php endif; ?>
                                    <?php if(in_array('address_pic',$editables)): ?>
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="address_pic" <?php echo e(in_array('address_pic',$editables)?'checked':''); ?>>پروف آدرس
                                        </label>
                                    </div>
                                    <?php endif; ?>
                                    <?php if(in_array('passport_pic',$editables)): ?>
                                    <div class="form-check-inline">
                                        <label class="form-check-label my-2">
                                            <input disabled type="checkbox" name="editables[]" class="form-check-input ml-2" value="passport_pic" <?php echo e(in_array('passport_pic',$editables)?'checked':''); ?>>پروف پاسپورت
                                        </label>
                                    </div>
                                    <?php endif; ?>
                                </div>
                                <a class="btn btn-primary mt-3"
                                   href="<?php echo e(route('profile-edit', auth()->user()->id)); ?>">ویرایش اطلاعات</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row <?php echo e(auth()->user()->account_status!='active'?'d-none':''); ?>">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="chart-container-1">
                                ...
                                <canvas id="chart1" style="display: block; width: 651px; height: 260px;" width="651"
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="p-3">
                                    ...
                                    <small class="mb-0">Visitor Duration <span> <i
                                                class="fa fa-arrow-up"></i> 12.65%</span></small>
                                </div>
                            </div>
                            <div class="col-12 col-lg-4">
                                <div class="p-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="chart-container-2">
                                ...
                                <canvas id="chart2" style="display: block; width: 293px; height: 188px;" width="293"
                                        height="188" class="chartjs-render-monitor"></canvas>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div id="dashboard-map" style="height: 275px;">
                                <div class="jvectormap-container" style="background-color: transparent;">
                                    <svg width="472" height="275">
                                        <defs></defs>
                                        <g transform="scale(0.5244444444444445) translate(0, 41.829048017764)">
                                            <path
                                                ...
                                                data-code="BD" fill="#fff" fill-opacity="1" stroke="none"
                                            ...
                                            <path
                                                ...
                                                data-code="BE" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BF" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BG" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BA" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M707.48,273.58l0.68,-0.65l1.41,-0.91l-0.15,1.63l-0.81,-0.05l-0.61,0.58l-0.53,-0.6Z"
                                                data-code="BN" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BO" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="JP" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M495.45,295.49l-1.08,-2.99l1.14,-0.11l0.64,-1.19l0.76,0.09l0.65,1.83l-2.1,2.36Z"
                                                data-code="BI" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="BW" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BR" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BS" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="BY" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M198.03,244.38l0.1,-4.49l0.69,-0.06l0.74,-1.3l0.34,0.28l-0.4,1.3l0.17,0.58l-0.34,2.25l-1.3,1.42Z"
                                                data-code="BZ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="RS" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="LT" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path d="M436.08,149.45l-0.48,-0.07l0.3,-1.28l0.27,0.4l-0.09,0.96Z"
                                                  data-code="LU" fill="#fff" fill-opacity="1" stroke="none"
                                                  stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                  class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="LR" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="RO" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GW" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GT" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GR" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path d="M448.79,279.62l0.02,2.22l-4.09,0.0l0.69,-2.27l3.38,0.05Z"
                                                  data-code="GQ" fill="#fff" fill-opacity="1" stroke="none"
                                                  stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                  class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GY" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GE" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="GB" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="GM" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="GH" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="JO" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="HR" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="HT" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="HU" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="PT" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PY" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PA" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PG" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PE" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PK" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PH" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="PL" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path d="M504.91,192.87l0.34,0.01l0.27,-0.07l-0.29,0.26l-0.31,-0.2Z"
                                                  data-code="-99" fill="#fff" fill-opacity="1" stroke="none"
                                                  stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                  class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ZM" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="EH" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="EE" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="EG" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ZA" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="EC" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AL" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AO" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="KZ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="ES" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ER" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M468.91,172.53l-1.22,-1.02l0.47,-1.81l0.89,-0.72l2.26,1.51l-0.5,0.57l-0.75,-0.27l-1.14,1.73Z"
                                                data-code="ME" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MD" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MG" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MA" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="UZ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MM" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ML" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MN" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MK" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MW" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MR" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="UG" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MY" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MX" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path d="M839.04,322.8l0.22,1.14l-0.44,0.03l-0.2,-1.45l0.42,0.27Z"
                                                  data-code="VU" fill="#fff" fill-opacity="1" stroke="none"
                                                  stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                  class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="FJ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="FK" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NI" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NL" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NO" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NA" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M838.78,341.24l-0.33,0.22l-2.9,-1.75l-3.26,-3.37l1.65,0.83l4.85,4.07Z"
                                                data-code="NC" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NE" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NG" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NZ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="NP" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CI" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CH" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CO" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CN" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CM" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CL" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CA" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CG" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CF" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CD" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CZ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M504.36,193.47l0.43,0.28l-1.28,0.57l-0.92,-0.28l-0.24,-0.46l2.01,-0.13Z"
                                                data-code="CY" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CR" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="CU" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M500.35,351.36l0.5,2.04l-0.38,0.89l-1.05,0.21l-1.23,-1.2l-0.02,-0.64l0.83,-1.57l1.34,0.27Z"
                                                data-code="SZ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SY" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="SS" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SR" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="KH" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M195.8,250.13l1.4,-1.19l2.24,1.45l0.98,-0.27l0.44,0.2l-0.27,1.05l-1.14,-0.03l-3.64,-1.21Z"
                                                data-code="SV" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SK" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="KR" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="SO" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SN" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SL" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SB" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SA" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SE" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="SD" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DO" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DJ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DK" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DE" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="YE" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AT" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="DZ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="US" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="LV" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="UY" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M510.37,198.01l-0.88,0.51l1.82,-3.54l0.62,0.08l0.22,0.61l-1.13,0.88l-0.65,1.47Z"
                                                data-code="LB" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="TM" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                data-code="TH" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M596.68,420.38l-3.2,0.18l-0.05,-1.26l0.39,-1.41l1.3,0.78l2.08,0.35l-0.52,1.36Z"
                                                data-code="TF" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="TG" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="TD" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="LY" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AE" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="VE" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AF" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IQ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IS" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IR" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AM" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IT" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="VN" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AR" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AU" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IL" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IN" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="TZ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="AZ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="IE" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="ID" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="UA" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                d="M549.33,221.64l-0.76,-0.23l-0.14,-1.64l0.84,-1.29l0.47,0.52l0.04,1.34l-0.45,1.3Z"
                                                data-code="QA" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                            <path
                                                ...
                                                data-code="MZ" fill="#fff" fill-opacity="1" stroke="none"
                                                stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                                class="jvectormap-region jvectormap-element"></path>
                                        </g>
                                        <g></g>
                                        <g>
                                            <circle data-index="0" cx="323.19799169107415" cy="143.36586929641874"
                                                    fill="#fff" stroke="#000" fill-opacity="1" stroke-width="5"
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td>4,586$</td>
                                    <td><span id="trendchart1"><canvas
                                                style="display: inline-block; width: 82px; height: 20px; vertical-align: top;"
                                                width="82" height="20"></canvas></span></td>
                                </tr>
                                <tr>
                                    <td><i class="flag-icon flag-icon-us mr-2"></i>Canada</td>
                                    <td>2,089$</td>
                                    <td><span id="trendchart2"><canvas
                                                style="display: inline-block; width: 82px; height: 20px; vertical-align: top;"
                                                width="82" height="20"></canvas></span></td>
                                </tr>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="card">
                                ...
                                <div class="chart-container-3">
                                    ...
                                    <canvas id="chart3" style="display: block; width: 244px; height: 188px;" width="244"
                                            height="188" class="chartjs-render-monitor"></canvas>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="card">
                                ...
                                <div class="chart-container-3">
                                    ...
                                    <canvas id="chart4" style="display: block; width: 244px; height: 188px;" width="244"
                                            height="188" class="chartjs-render-monitor"></canvas>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div style="display:inline;width:175px;height:175px;">
                                        ...
                                        <input class="knob" data-width="175" data-height="175" data-readonly="true"
                                               ...
                                               data-max="15000" value="8550" readonly="readonly"
                                               style="width: 91px; height: 58px; position: absolute; vertical-align: middle; margin-top: 58px; margin-left: -133px; border: 0px none; background: rgba(0, 0, 0, 0) none repeat scroll 0% 0%; font: bold 25px Arial; text-align: center; color: rgb(255, 255, 255); padding: 0px; -moz-appearance: none;">
                                    </div>
                                    <hr>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-5">
                                <div class="chart-container-4">
                                    ...
                                    <canvas id="chart5" style="display: block; width: 293px; height: 162px;" width="293"
                                            height="162" class="chartjs-render-monitor"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item bg-transparent">
                                <div class="media align-items-center">
                                    <img src="<?php echo e(asset('dashboard/avatar-13.png')); ?>" alt="user avatar"
                            ...
                            <li class="list-group-item bg-transparent">
                                <div class="media align-items-center">
                                    <img src="<?php echo e(asset('dashboard/avatar-15.png')); ?>" alt="user avatar"
                                         class="customer-img rounded-circle">
                                    <div class="media-body ml-3">
                            ...
                            <li class="list-group-item bg-transparent">
                                <div class="media align-items-center">
                                    <img src="<?php echo e(asset('dashboard/avatar-14.png')); ?>" alt="user avatar"
                                         class="customer-img rounded-circle">
                                    <div class="media-body ml-3">
                            ...
                            <li class="list-group-item bg-transparent">
                                <div class="media align-items-center">
                                    <img src="<?php echo e(asset('dashboard/avatar-16.png')); ?>" alt="user avatar"
                                         class="customer-img rounded-circle">
                                    <div class="media-body ml-3">
                            ...
                            <li class="list-group-item bg-transparent">
                                <div class="media align-items-center">
                                    <img src="<?php echo e(asset('dashboard/avatar-17.png')); ?>" alt="user avatar"
                                         class="customer-img rounded-circle">
                                    <div class="media-body ml-3">
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush table-borderless">
                                ...
                                <tr>
                                    <td>Iphone 5</td>
                                    <td><img src="<?php echo e(asset('dashboard/01.png')); ?>" class="product-img" alt="product img">
                                    </td>
                                    <td>#9405822</td>
                                    <td>$ 1250.00</td>
                                    <td>03 Aug 2017</td>
                                ...
                                <tr>
                                    <td>Earphone GL</td>
                                    <td><img src="<?php echo e(asset('dashboard/02.png')); ?>" class="product-img" alt="product img">
                                    </td>
                                    <td>#9405820</td>
                                    <td>$ 1500.00</td>
                                    <td>03 Aug 2017</td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo e(asset('dashboard/03.png')); ?>" class="product-img" alt="product img">
                                    </td>
                                    <td>#9405830</td>
                                    <td>$ 1400.00</td>
                                    <td>03 Aug 2017</td>
                                ...
                                <tr>
                                    <td>Clasic Shoes</td>
                                    <td><img src="<?php echo e(asset('dashboard/04.png')); ?>" class="product-img" alt="product img">
                                    </td>
                                    <td>#9405825</td>
                                    <td>$ 1200.00</td>
                                    <td>03 Aug 2017</td>
                                ...
                                <tr>
                                    <td>Hand Watch</td>
                                    <td><img src="<?php echo e(asset('dashboard/05.png')); ?>" class="product-img" alt="product img">
                                    </td>
                                    <td>#9405840</td>
                                    <td>$ 1800.00</td>
                                    <td>03 Aug 2017</td>
                                ...
                                <tr>
                                    <td>Clasic Shoes</td>
                                    <td><img src="<?php echo e(asset('dashboard/06.png')); ?>" class="product-img" alt="product img">
                                    </td>
                                    <td>#9405825</td>
                                    <td>$ 1200.00</td>
                                    <td>03 Aug 2017</td>
        ...
        <?php $__env->startPush('scripts'); ?>
            ...
            <script src="<?php echo e(asset('dashboard/index.js')); ?>"></script>
            <script>
                function copyText() {
                    /* Get the text field */
                    ...
                    $.jGrowl('کپی شد', {life: 3000, position: 'bottom-right', theme: 'bg-success'});
                }
                function copyToClipboard() {
                    var elem=document.getElementById("share_link");
