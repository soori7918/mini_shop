        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                <div class="ltn__shop-details-inner ltn__page-details-inner mb-60">
                                ...
                                <?php $__currentLoopData = $item->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-12">
                                        <div class="ltn__img-slide-item-4">
                                            <a href="<?php echo e($photo->path?url($photo->path):url('assets/user/pic/slider_33.jpg')); ?>" data-rel="lightcase:myCollection">
                                                <img src="<?php echo e($photo->path?url($photo->path):url('assets/user/pic/slider_33.jpg')); ?>" alt="<?php echo e($item->name); ?>">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <?php if(count($item->in_gallery)>0): ?>
                                    <li>
                                        ...
                                        <?php $__currentLoopData = $item->in_gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_in=> $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($key_in>0): ?>
                                                <a hidden href="<?php echo e($in->path?url($in->path):url('assets/user/pic/slider_33.jpg')); ?>" data-rel="lightcase:myCollection_in">
                                                    <img src="<?php echo e($in->path?url($in->path):url('assets/user/pic/slider_33.jpg')); ?>" alt="<?php echo e($item->name); ?>">
                                                </a>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </li>
                                ...
                                <?php if(count($item->out_gallery)>0): ?>
                                        <li>
                                            ...
                                            <?php $__currentLoopData = $item->out_gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_out=>$out): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($key_out>0): ?>
                                                    <a hidden href="<?php echo e($out->path?url($out->path):url('assets/user/pic/slider_33.jpg')); ?>" data-rel="lightcase:myCollection_out">
                                                        <img src="<?php echo e($out->path?url($out->path):url('assets/user/pic/slider_33.jpg')); ?>" alt="<?php echo e($item->name); ?>">
                                                    </a>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </li>
                                ...
                                <?php if(count($item->plan_gallery)>0): ?>
                                        <li>
                                            ...
                                            <?php $__currentLoopData = $item->plan_gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_plan=>$plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($key_plan>0): ?>
                                                    <a hidden href="<?php echo e($plan->path?url($plan->path):url('assets/user/pic/slider_33.jpg')); ?>" data-rel="lightcase:myCollection_plan">
                                                        <img src="<?php echo e($plan->path?url($plan->path):url('assets/user/pic/slider_33.jpg')); ?>" alt="<?php echo e($item->name); ?>">
                                                    </a>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </li>
                    ...
                    <?php if($item->video || $item->link1 || $item->link2 || $item->link3 || $item->link4): ?>
                        <div class="box_show_villa">
                        ...
                        <div class="ltn__video-bg-img ltn__video-popup-height-500 bg-overlay-black-50 bg-image mb-60"
                             data-bg="<?php echo e(url('assets/user/pic/video.jpg')); ?>">
                            <?php if($item->video): ?>
                                    ...
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="<?php echo e(route('user.project.show',$project->id)); ?>">
                                                ...
                                                <?php else: ?>
                                                    <img src="<?php echo e($project->pic!=null?url($project->pic):url('assets/user/pic/product.jpg')); ?>"
                                                         alt="<?php echo e($project->name); ?>">
                                                <?php endif; ?>
                                            </a>
                                        </div>
                                    ...
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="<?php echo e(route('user.blog.show',$blogs->id)); ?>"><img
                                                        src="<?php echo e($blogs->photo?url($blogs->photo):url('assets/user/pic/product.jpg')); ?>"
                                                        alt="#"></a>
                                        </div>
