<?php $__env->startComponent('layouts.back'); ?>
    ...
    <?php $__env->slot('body'); ?>
        <div class="card">
            ...
            <div class="card-body">
                <?php echo e(Form::open(array('route' => 'gallery-store', 'method' => 'PUT'))); ?>

                <div class="form-group">
                    <?php echo e(Form::label('villa_id', 'ویلا')); ?>

                    <?php echo e(Form::select('villa_id', array_pluck($villas, 'name', 'id'), '', array('class' => 'form-control selectpicker'))); ?>
