                        ...
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('villa-list')); ?>">لیست ویلا‌ها</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('location-list')); ?>">لیست مقاصد</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('gallery-list')); ?>">گالری ویلا</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('location-gallery-list')); ?>">گالری مقصد</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('newsletter-list-location')); ?>">لیست عضوهای هر مقصد</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('newsletter-list-villa')); ?>">لیست عضوهای هر ویلا</a>
                                    </li>
                                    <li>
