        ...
        <div class="card text-center" dir="rtl">
            ...
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td width="140">
                                    <div class="btn-inline">
                                        <a href="<?php echo e(route('faq-edit', $item->id)); ?>" class="btn btn-sm btn-info float-left mr-1"><i class="fa fa-edit ml-1"></i>ویرایش</a>
                ...
                <div class="paginate p-3">
                    ...
                    <a href="<?php echo e(route('faq-create')); ?>" class="btn btn-rounded btn-primary float-left"><i class="fa fa-circle-o ml-1"></i>افزودن</a>
                </div>
            </div>
        </div>
    <?php $__env->endSlot(); ?>
