            ...
            <div class="card-body">
                <div class="row mt-4 mb-4">
                    ...
                    <div class="col-md-4 post">
                        <?php if($post->file): ?>
                            <img src="<?php echo e(url($post->file)); ?>" alt="<?php echo e($post->title); ?>" width="250px">
                        <?php else: ?>
                            <img src="<?php echo e(asset('img/default.jpg')); ?>" alt="<?php echo e($post->title); ?>">
                        <?php endif; ?>
                        <ul class="list-group mt-3">
                            <li class="list-group-item"><strong>شاکی : </strong><?php echo e($post->user->first_name); ?> <?php echo e($post->user->last_name); ?></li>
                            <li class="list-group-item"><strong>متشاکی : </strong><?php echo e($post->form->first_name); ?> <?php echo e($post->form->last_name); ?></li>
                            <li class="list-group-item"><strong>تاریخ مشاجره : </strong><?php echo e(my_jdate($post->date, 'd F Y ')); ?></li>
                ...
                <a href="<?php echo e(route('complain-edit', $post->id)); ?>" class="btn btn-rounded btn-success float-left mr-1"><i class="fa fa-edit ml-1"></i>ویرایش</a>
            </div>
        </div>
    <?php $__env->endSlot(); ?>
